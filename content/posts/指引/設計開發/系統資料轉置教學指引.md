...
| 章節 | 內容概述 |
|------|---------|
| [第 1 章](#第-1-章資料轉置整體概念與常見失敗原因) | 資料轉置整體概念與常見失敗原因 |
| [第 2 章](#第-2-章舊系統分析as-is-analysis) | 舊系統分析（As-Is Analysis） |
| [第 3 章](#第-3-章新系統設計to-be-design) | 新系統設計（To-Be Design） |
| [第 4 章](#第-4-章資料轉置策略與架構設計) | 資料轉置策略與架構設計 |
| [第 5 章](#第-5-章資料轉置流程設計etl-flow) | 資料轉置流程設計（ETL Flow） |
| [第 6 章](#第-6-章資料驗證與比對機制) | 資料驗證與比對機制 |
| [第 7 章](#第-7-章工具與技術選型建議) | 工具與技術選型建議 |
| [第 8 章](#第-8-章測試策略與上線前檢核) | 測試策略與上線前檢核 |
| [第 9 章](#第-9-章實務經驗與最佳實踐) | 實務經驗與最佳實踐 |
...
- [第 1 章：資料轉置整體概念與常見失敗原因](#第-1-章資料轉置整體概念與常見失敗原因)
  - [1.1 Data Migration vs Data Transformation 差異](#11-data-migration-vs-data-transformation-差異)
  - [1.2 為何資料轉置是高風險專案](#12-為何資料轉置是高風險專案)
  - [1.3 常見失敗原因與風險分析](#13-常見失敗原因與風險分析)
- [第 2 章：舊系統分析（As-Is Analysis）](#第-2-章舊系統分析as-is-analysis)
  - [2.1 資料來源盤點](#21-資料來源盤點)
  - [2.2 資料結構分析](#22-資料結構分析)
  - [2.3 Key 與邏輯關聯分析](#23-key-與邏輯關聯分析)
  - [2.4 資料品質檢測](#24-資料品質檢測)
- [第 3 章：新系統設計（To-Be Design）](#第-3-章新系統設計to-be-design)
  - [3.1 新系統資料模型設計原則](#31-新系統資料模型設計原則)
  - [3.2 舊欄位到新欄位 Mapping 規則](#32-舊欄位到新欄位-mapping-規則)
  - [3.3 Code / Enum / Reference Data 對應策略](#33-code--enum--reference-data-對應策略)
  - [3.4 歷史資料保留與否的決策考量](#34-歷史資料保留與否的決策考量)
- [第 4 章：資料轉置策略與架構設計](#第-4-章資料轉置策略與架構設計)
...
- [第 5 章：資料轉置流程設計（ETL Flow）](#第-5-章資料轉置流程設計etl-flow)
  - [5.1 Extract（資料抽取）](#51-extract資料抽取)
  - [5.2 Transform（資料轉換）](#52-transform資料轉換)
...
- [第 6 章：資料驗證與比對機制](#第-6-章資料驗證與比對機制)
  - [6.1 筆數驗證（Record Count）](#61-筆數驗證record-count)
  - [6.2 金額 / 數值驗證（Sum / Balance Check）](#62-金額--數值驗證sum--balance-check)
  - [6.3 Key-based 資料比對](#63-key-based-資料比對)
  - [6.4 抽樣驗證（Sampling）](#64-抽樣驗證sampling)
  - [6.5 自動化驗證報表設計](#65-自動化驗證報表設計)
- [第 7 章：工具與技術選型建議](#第-7-章工具與技術選型建議)
  - [7.1 SQL / Stored Procedure](#71-sql--stored-procedure)
  - [7.2 ETL 工具](#72-etl-工具)
  - [7.3 程式語言選擇](#73-程式語言選擇)
  - [7.4 檔案處理工具](#74-檔案處理工具)
  - [7.5 驗證與測試輔助工具](#75-驗證與測試輔助工具)
- [第 8 章：測試策略與上線前檢核](#第-8-章測試策略與上線前檢核)
  - [8.1 Unit Test（轉換邏輯）](#81-unit-test轉換邏輯)
  - [8.2 Integration Test（流程驗證）](#82-integration-test流程驗證)
  - [8.3 UAT 驗證模式](#83-uat-驗證模式)
  - [8.4 上線前 Checklist](#84-上線前-checklist)
- [第 9 章：實務經驗與最佳實踐](#第-9-章實務經驗與最佳實踐)
  - [9.1 常見踩雷案例](#91-常見踩雷案例)
  - [9.2 與業務單位的資料驗證合作方式](#92-與業務單位的資料驗證合作方式)
  - [9.3 文件化、稽核與可追溯性設計](#93-文件化稽核與可追溯性設計)
  - [9.4 金融與核心系統常見合規考量](#94-金融與核心系統常見合規考量)
- [附錄 A：資料轉置專案檢查清單（Checklist）](#附錄-a資料轉置專案檢查清單checklist)
  - [A.1 專案啟動階段](#a1-專案啟動階段)
  - [A.2 分析設計階段](#a2-分析設計階段)
  - [A.3 開發測試階段](#a3-開發測試階段)
  - [A.4 UAT 階段](#a4-uat-階段)
  - [A.5 上線階段](#a5-上線階段)
- [附錄 B：常用 SQL 範本](#附錄-b常用-sql-範本)
  - [B.1 資料品質檢測](#b1-資料品質檢測)
  - [B.2 資料比對](#b2-資料比對)
...
> |---------|---------|
> | Data Loss | 資料遺失 |
> | Transform Error | 轉換邏輯錯誤 |
> | Performance Issue | 效能不足 |
> | Format Compatibility | 格式相容問題 |
> | Permission Error | 權限設定錯誤 |
