...
version: v1.0
date: 2026-06-17
tags: [loop-engineering, AI-agent, claude-code, github-copilot, enterprise, SSDLC, ReAct, OODA]
categories: [AI開發, 架構設計, 最佳實務, 企業培訓]
description: >
  企業級 Loop Engineering 完整教學手冊。涵蓋核心理論（ReAct / OODA / PDCA）、
  系統架構、六大核心元件、Claude Code / GitHub Copilot 實戰、Legacy 逆向工程、
  Spring Boot 升級、Evals 設計、AI Agent Team、SSDLC 整合，以及 50+ Prompt 範本、
  50 Best Practices、50 Anti-patterns，適合企業 AI 開發團隊培訓使用。
audience: [架構師, 技術主管, AI Architect, Backend Developer, Frontend Developer, DevOps Engineer, SRE, Security Engineer, Tech Lead, Enterprise Architect]
---

# Loop Engineering 教學手冊

> **版本**：v1.0　|　**更新日期**：2026-06-17　|　**適用對象**：資深工程師、架構師、技術主管
...
## 附錄 I　補充 Prompt Library（Prompt-021 ~ Prompt-055）
...
## 附錄 J　補充 SOP 集合（SOP-010 ~ SOP-029）
...
*《Loop Engineering 教學手冊》v1.0 — 2026-06-17*
