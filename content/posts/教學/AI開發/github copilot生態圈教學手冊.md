...
| **Third-party Agents** | Anthropic / OpenAI 等代理 | 使用特定 AI 提供者能力 | 依任務需求選擇最佳代理 |
...
| **Copilot CLI Agent** | 本機背景執行 | 明確定義的獨立任務 | 使用 Git worktree 隔離，不影響當前工作 |
| **Cloud Agent** | 遠端雲端基礎設施 | 團隊協作、PR 導向任務 | 建立分支並開 PR，適合團隊 Review |
| **Third-party Agent** | 第三方提供者 | 使用特定 AI 能力 | 支援 Anthropic、OpenAI 等提供者 |
