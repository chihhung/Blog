...
> **版本**：基於 OpenCode v1.4.6（2026 年 4 月）  
...
- [第十章：Oh My OpenAgent（OmO）生態系](#第十章oh-my-openagentomo生態系)
  ...
  - [10.29 OmO v3.14-v3.17.3 更新摘要](#1029-omo-v314-v3173-更新摘要)
- [第十一章：OpenWork 桌面應用與協作平台](#第十一章openwork-桌面應用與協作平台)
  ...
  - [11.18 OpenWork v0.11.192-v0.11.207 更新摘要](#1118-openwork-v011192-v011207-更新摘要)
...
| 語言/技術 | 佔比 | 用途 |
|-----------|------|------|
| TypeScript | 58.0% | 核心引擎、工具系統 |
| MDX | 38.2% | 文件系統 |
| CSS | 2.9% | TUI 樣式 |
| Rust | 0.5% | 效能關鍵路徑、Desktop App |
| Astro | 0.2% | 文件網站 |
| Shell | 0.1% | 安裝腳本、CI/CD |
...
graph TB
    subgraph "OpenCode 生態系"
        subgraph "核心層"
            OC["OpenCode Core<br/>v1.4.6<br/>144k ⭐ | MIT"]
        end

        subgraph "增強層"
            OmO["Oh My OpenAgent (OmO)<br/>v3.17.3<br/>51.9k ⭐ | SUL"]
            OW["OpenWork<br/>v0.11.207<br/>13.8k ⭐ | MIT"]
        end

        subgraph "整合層"
            SDK["OpenCode SDK<br/>v1.4.x"]
...
|------|------|--------|------|-------|------|
| **OpenCode** | AI 編碼代理核心 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | v1.4.6 | 144k | MIT |
| **Oh My OpenAgent** | 進階外掛（多代理協作） | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | v3.17.3 | 51.9k | SUL |
| **OpenWork** | 桌面 GUI 協作平台 | [different-ai/openwork](https://github.com/different-ai/openwork) | v0.11.207 | 13.8k | MIT |
...
| v1.4.6 | 2026-04-15 | 最新穩定版；oxlint 整合（correctness + suspicious 規則）、provider auth HTTP API 切片、清理 49+ 未使用變數、全面程式碼品質提升 |
...
| v3.17.0 | 最新版，162 releases；更名 oh-my-openagent、OpenCode v1.4.0 最低版本檢查、Doctor 診斷命令、Session Recovery、File Prompts、Model Fallbacks 物件設定、frontend-ui-ux 技能 |
| v3.17.3 | 最新版，164 releases、51.9k ⭐、194 貢獱者；replace_plan 支援（隱藏原生 Plan Agent）、CLA 貢獱者授權協議、PostHog 匿名 Telemetry、Sisyphus Labs 產品化等待名單 |
...
| v0.11.206 | 最新版，1,055 releases；Ollama 支援、React Session Composer、i18n 五語系（en/ja/zh/vi/pt-BR）、授權變更為 FSL-1.1-MIT、AUR 套件、Debug 匯出、Provider Library 管理 |
| v0.11.207 | 最新版，1,057 releases、13.8k ⭐、54 貢獱者；Composer 精練、Landing 頁面刷新、Catalan 語系新增（i18n 擴展至 6 語系）、microsandbox 沙箱流程、Roadmap 分頁、Node 24 CI 準備、Windows 免費下載恢復 |
...
graph TB
    subgraph "介面層（Clients）"
        TUI["TUI（終端機介面）"]
        Desktop["Desktop App"]
        IDE["IDE Extension<br/>（VS Code SDK v1.4.6）"]
        Web["Web 介面"]
        Mobile["遠端操控<br/>（行動裝置）"]
...
OpenCode 提供 **VS Code 擴充（SDK v1.4.6）**：
...
### 10.29 OmO v3.14-v3.17 更新摘要

OmO 自 v3.13 至 v3.17.3 持續快速迭代，以下為關鍵更新：
...
| 貢獻者 | **54+** |
| 版本發佈 | **1,057+** |
| 授權 | **MIT**（先前為 FSL-1.1-MIT，已轉換為 MIT） |
| 技術堆疊 | TypeScript 83.7% / JavaScript 7.1% / Rust 4.9% / CSS 2.9% / Shell 0.8%（Tauri） |
| OpenCode 版本 PIN | **1.4.x**（CI 固定，透過 `constants.json`） |
| 官方網站 | [openworklabs.com](https://openworklabs.com) |
| Desktop Framework | **Tauri**（輕量跨平台桌面框架） |
| 應用程式語言 | 英文、日文、簡體中文、越南文、巴西葡萄牙文、加泰羅尼亞文 |
...
### 11.18 OpenWork v0.11.192-v0.11.207 更新摘要
...
> **文件結束**  
> 本文件涵蓋 OpenCode v1.4.6、Oh My OpenAgent v3.17.3、OpenWork v0.11.207 的完整生態系教學。  
