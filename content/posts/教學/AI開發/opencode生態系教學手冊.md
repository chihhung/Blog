...
> **版本**：基於 OpenCode v1.17.11（2026 年 6 月）  
...
| 3.0 | 2026-03-25 | 軟體架構組 | 更新至 v1.3.2；OmO v3.13.1 新增 Multimodal Looker / Metis 代理與 Agent Orchestration；OpenWork v0.11.191 新增 Dev Mode、Templates、Cloud Worker |
| 3.0 | 2026-03-25 | 軟體架構組 | 全面更新至 OpenCode v1.3.2、OmO v3.13.1、OpenWork v0.11.191；新增 Multimodal Looker、Metis、Agent Orchestration 分類路由、雲端 Worker 架構等新功能 |
| 4.0 | 2026-04-12 | 軟體架構組 | 全面更新至 OpenCode v1.4.3、OmO v3.17.0、OpenWork v0.11.206；OpenCode 新增 OpenCode Go 訂閱、40+ 提供商支援、Docker 安裝、Ollama Cloud；OmO 更名 oh-my-openagent、OpenCode v1.4.0 最低版本檢查、Doctor 診斷命令、Session Recovery、File Prompts；OpenWork 授權變更為 FSL-1.1-MIT、Ollama 支援、React Session Composer、i18n 五語系 |
| 5.0 | 2026-04-16 | 軟體架構組 | 更新至 OpenCode v1.4.6（762 releases、oxlint 整合、provider auth API）、OmO v3.17.3（164 releases、replace_plan 支援、CLA 與 Telemetry 機制）、OpenWork v0.11.207（1,057 releases、Catalan 語系、microsandbox 沙箱流程、Roadmap 分頁、Node 24 CI 準備）；新增 multiedit 工具、Sisyphus Labs 等待名單、提供商新增 40+ 項 |
| 6.0 | 2026-04-30 | 軟體架構組 | 全面更新至 OpenCode v1.14.30（781 releases、152k Stars、875 貢獻者、question 工具、agent create CLI、Desktop App BETA 正式化）、OmO v3.17.10（168 releases、55.1k Stars、199 貢獻者、GPT-5.5 native prompt drafts、npm OIDC CI 改進）、OpenWork v0.13.0（1,087 releases、14.5k Stars、Tauri→Electron 遷移、Cloud MCP OAuth Server、Welcome/Onboarding 畫面、microsandbox 功能旗標、pnpm workspace 重構）；新增 ACP 支援文件、SDK 文件、Server 文件、外掛文件、生態系統文件 |
| 7.0 | 2026-05-14 | 軟體架構組 | 全面更新至 OpenCode v1.14.50（800 releases、160k Stars、896 貢獻者、Scout SubAgent 新增、native LLM core foundation、TUI notifications、Electron Desktop CI 改進）、OmO v4.1.2（177 releases、57.7k Stars、219 貢獻者、Team Mode v4.0 多代理並行、hyperplan/security-research 技能、Kimi K2.6/GPT-5.5/GLM-5.1 模型支援、configurable agent ordering、CDP browser tools）、OpenWork v0.13.8（1,202 releases、15.2k Stars、61 貢獻者、shadcn/ui skills、Electron browser automation、Daytona/devcontainer、native main menu、10 語系支援、AI Providers 重構） |
| 8.0 | 2026-05-31 | 軟體架構組 | 全面更新至 OpenCode v1.15.13（815 releases、168k Stars、921 貢獻者、database schema 重構、keymap fallback 改進、gcp metadata 修正、stats 路由功能、nix 更新）、OmO v4.5.12（187 releases、60.4k Stars、268 貢獻者、Multi-Harness Agent OS 重構支援 OpenCode/Codex/Pi 多平台、lazycodex Light Edition、omo-codex 可攜版、54+ 生命週期掛鉤、security-review 內建技能、.agents 目錄遷移）、OpenWork v0.14.0（1,346 releases、15.7k Stars、62 貢獻者、Google Workspace OAuth、Voice mode CDP 音訊檢查、pnpm v11 遷移、內建擴充市集、SCIM/SSO 企業管理流程、新版訊息列表 UI、embedded OpenCode 升級至 v1.15.12） |
| 9.0 | 2026-06-30 | 軟體架構組 | 全面更新至 OpenCode v1.17.11（828 releases、181k Stars、959 貢獻者、VS Code Extension v1.17.11 同步發佈、Desktop Electron session title hover 改進、stats route 功能完善、GitHub issue actions 優化、SDK v2 SSE streams 修正、location node 重構）、OmO v4.14.1（208 releases、64.3k Stars、290 貢獻者、Multi-Harness Agent OS 重構完成支援 OpenCode/Codex/Pi/Claude Code 四平台、LazyCodex Light Edition 正式版八組件發佈、telemetry 架構統一 DAU/WAU/MAU 追蹤、omo-opencode 套件獨立模組化、source-state 修復、Codegraph MCP server 新增、共享技能 frontend 子模組化）、OpenWork v0.17.4（1,610 releases、16.5k Stars、65 貢獻者、重新定位為 Claude Cowork 開源替代品、SignPath.io 免費程式碼簽署、Enterprise Plan 正式化含 SSO/SLA/LTS、OpenWork Orchestrator CLI 獨立套件、Docker images 發佈 den-api/eval-vnc/charts、pnpm v10.27.0 + Bun 1.3.9+ 環境要求、Windows 付費支援計畫、Dev Mode 隔離 OPENWORK_DEV_MODE 自動啟用、10 語系支援完善） |
...
- [第一章：OpenCode 生態系總覽](#第一章opencode-生態系總覽)
  ...
  - [1.6 真實案例研究](#16-真實案例研究)
  - [1.7 版本演進與藍圖](#17-版本演進與藍圖)
...
- [第五章：實戰操作教學](#第五章實戰操作教學)
  ...
  - [5.8 使用 Explore / Scout SubAgent 探索程式碼庫與外部文件](#58-使用-explore--scout-subagent-探索程式碼庫與外部文件)
  - [5.9 使用自訂指令加速工作流程](#59-使用自訂指令加速工作流程)
  - [5.10 網路搜尋與網頁擷取](#510-網路搜尋與網頁擷取)
  - [5.11 LSP 整合操作](#511-lsp-整合操作)
  - [5.12 實戰範例：完整的 CRUD API 開發流程](#512-實戰範例完整的-crud-api-開發流程)
- [第六章：最佳實踐（Best Practices）](#第六章最佳實踐best-practices)
  ...
  - [6.9 多語言專案管理策略](#69-多語言專案管理策略)
  - [6.10 程式碼審查最佳實踐](#610-程式碼審查最佳實踐)
  - [6.11 TDD/BDD 與 OpenCode 整合](#611-tddbdd-與-opencode-整合)
  - [6.12 安全編碼規範指南](#612-安全編碼規範指南)
  - [6.13 效能優化策略](#613-效能優化策略)
...
- [第九章：企業導入建議](#第九章企業導入建議)
  ...
  - [9.6 企業版功能](#96-企業版功能)
  - [9.7 企業級安全治理架構](#97-企業級安全治理架構)
  - [9.8 企業導入常見挑戰與解決方案](#98-企業導入常見挑戰與解決方案)
  - [9.9 多團隊統一管理方案](#99-多團隊統一管理方案)
  - [9.10 成本分析與 ROI 模型](#910-成本分析與-roi-模型)
- [第十章：Oh My OpenAgent（OmO）生態系](#第十章oh-my-openagentomo生態系)
  ...
  - [10.20 OmO 實戰教學：微服務拆分](#1020-omo-實戰教學微服務拆分)
  - [10.21 OmO 與 OpenCode 功能對照表](#1021-omo-與-opencode-功能對照表)
  - [10.22 OmO 效能調優指南](#1022-omo-效能調優指南)
  - [10.23 Multimodal Looker 代理（v3.12+ 新增）](#1023-multimodal-looker-代理v312-新增)
  - [10.24 Metis 代理——規劃顧問（v3.12+ 新增）](#1024-metis-代理規劃顧問v312-新增)
  - [10.25 GPT-5.5 xhigh 路由與 ultrabrain 模式（v3.13+ 新增）](#1025-gpt-55-xhigh-路由與-ultrabrain-模式v313-新增)
  - [10.26 Session Tools——歷程分析（v3.13+ 新增）](#1026-session-tools歷程分析v313-新增)
  - [10.27 Think Mode（v3.13+ 新增）](#1027-think-modev313-新增)
  - [10.28 OmO v3.13 其他更新](#1028-omo-v313-其他更新)
  - [10.29 OmO v3.14-v3.17.10 更新摘要](#1029-omo-v314-v31710-更新摘要)
  - [10.30 OmO v4.0-v4.5.12 更新摘要（Team Mode 與 Multi-Harness OS 重大版本）](#1030-omo-v40-v4512-更新摘要team-mode-與-multi-harness-os-重大版本)
  - [10.31 OmO v4.6-v4.14.1 更新摘要（Multi-Harness 完成與 LazyCodex 正式版）](#1031-omo-v46-v4141-更新摘要multi-harness-完成與-lazycodex-正式版)
- [第十一章：OpenWork 桌面應用與協作平台](#第十一章openwork-桌面應用與協作平台)
  ...
  - [11.12 Dev Mode 隔離（v0.11.160+ 新增）](#1112-dev-mode-隔離v011160-新增)
  - [11.13 Templates 儲存與重播（v0.11.170+ 新增）](#1113-templates-儲存與重播v011170-新增)
  - [11.14 Execution Plan Timeline（v0.11.180+ 新增）](#1114-execution-plan-timelinev011180-新增)
  - [11.15 Cloud Worker 架構（v0.11.185+ 新增）](#1115-cloud-worker-架構v011185-新增)
  - [11.16 Workspace Switch 與 Starter Sessions（v0.11.190+ 新增）](#1116-workspace-switch-與-starter-sessionsv011190-新增)
  - [11.17 OpenCode Plugins 管理（Skills Tab）](#1117-opencode-plugins-管理skills-tab)
  - [11.18 OpenWork v0.11.192-v0.14.0 更新摘要](#1118-openwork-v011192-v0140-更新摘要)
  - [11.19 OpenWork v0.14.1-v0.17.4 更新摘要](#1119-openwork-v0141-v0174-更新摘要)
  - [11.20 企業導入 OpenWork 建議](#1120-企業導入-openwork-建議)
- [第十二章：生態系整合與進階工作流程](#第十二章生態系整合與進階工作流程)
  ...
  - [12.8 CI/CD 管線深度整合](#128-cicd-管線深度整合)
  - [12.9 多倉庫聯合開發模式](#129-多倉庫聯合開發模式)
  - [12.10 資料庫遷移自動化](#1210-資料庫遷移自動化)
  - [12.11 監控與可觀察性整合](#1211-監控與可觀察性整合)
  - [12.12 基礎架構即程式碼（IaC）整合](#1212-基礎架構即程式碼iac整合)
  - [12.13 企業級日誌與稽核系統](#1213-企業級日誌與稽核系統)
  - [12.14 企業災難復原與高可用方案](#1214-企業災難復原與高可用方案)
...
OpenCode 是一個 **100% 開源** 的 AI 編碼代理（AI Coding Agent），由 Anomaly 團隊開發維護。截至 2026 年 6 月，OpenCode 已達到以下里程碑：
...
| Agent 架構 | 內建 5 個代理（Build、Plan、General、Explore、Scout）+ 3 個隱藏系統代理 |
...
| 語言/技術 | 佔比 | 用途 |
|-----------|------|------|
| TypeScript | 70.5% | 核心引擎、工具系統、代理系統、SDK |
| MDX | 26.0% | 文件系統 |
| CSS | 3.0% | TUI 樣式、Desktop App |
| HTML | 0.2% | 網頁模板 |
| JavaScript | 0.1% | 安裝腳本、工具 |
| Astro | 0.1% | 文件網站 |
| Other | <0.1% | Rust、Shell、Nix、CI/CD |
...
graph TB
    subgraph "OpenCode 生態系"
        subgraph "核心層"
            OC["OpenCode Core<br/>v1.17.11<br/>181k ⭐ | MIT"]
        end

        subgraph "增強層"
            OmO["Oh My OpenAgent (OmO)<br/>v4.14.1<br/>64.3k ⭐ | SUL"]
            OW["OpenWork<br/>v0.17.4<br/>16.5k ⭐ | MIT"]
        end

        subgraph "整合層"
            SDK["OpenCode SDK<br/>v1.17.x"]
            Plugin["外掛系統<br/>npm plugins"]
            MCP["MCP 伺服器<br/>本地/遠端/OAuth"]
            LazyCodex["LazyCodex<br/>OmO Light for Codex CLI"]
        end
...
|------|------|--------|------|-------|------|
| **OpenCode** | AI 編碼代理核心 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | v1.17.11 | 181k | MIT |
| **Oh My OpenAgent** | 進階外掛（多代理協作） | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | v4.14.1 | 64.3k | SUL |
| **OpenWork** | 桌面 GUI 協作平台（Claude Cowork 開源替代） | [different-ai/openwork](https://github.com/different-ai/openwork) | v0.17.4 | 16.5k | MIT |
...
2. **內建工具系統**：bash、edit、write、read、grep、glob、patch、lsp、skill、todowrite、webfetch、websearch、question 等 13 個工具讓 AI 能夠直接操作開發環境
...
| **Client/Server** | ❌ | ❌ | ❌ | ✅ | ✅ |
| **多代理協作** | 有限 | 有限 | 有限 | ✅ 5 代理 | ✅ Team Mode 8+ 並行 |
...
| v1.2.21 | 2026-03-08 | SDK VS Code Extension 穩定版 |
| v1.3.2 | 2026-03-25 | Electron Desktop App 改進、MCP OAuth 增強 |
| v1.4.3 | 2026-04-10 | OpenCode Go 訂閱、Docker 安裝、Ollama Cloud、40+ 提供商支援、VS Code SDK v1.4.3 |
| v1.4.6 | 2026-04-15 | oxlint 整合（correctness + suspicious 規則）、provider auth HTTP API 切片、清理 49+ 未使用變數、全面程式碼品質提升 |
| v1.14.30 | 2026-04-30 | 152k Stars、875 貢獻者、781 releases；question 工具、agent create CLI 互動式建立代理、Desktop App BETA 正式化、VS Code SDK v1.14.30、server status indicator 修正、sourcemaps for beta releases、HttpApi instance context middleware、type-aware no-floating-promises 規則 |
| v1.14.50 | 2026-05-14 | 160k Stars、896 貢獻者、800 releases；Scout SubAgent 新增（外部文件與依賴研究唯讀代理）、native LLM core foundation、TUI notifications 與 attention sounds、Electron Desktop CI native arm64 runner、keymap fallback priority 與 TUI config diagnostics、v2 model listing API、session usage totals tracking |
| v1.15.13 | 2026-05-31 | 168k Stars、921 貢獻者、815 releases；database schema 重構（migration 機制優化）、keymap fallback 改進、gcp metadata 修正、stats 路由功能新增、nix flake 更新、OpenCode Zen 供應商支援、ACP 支援、external_directory/doom_loop 權限機制 |
| v1.17.11 | 2026-06-30 | **最新穩定版**；181k Stars、959 貢獻者、828 releases；VS Code Extension v1.17.11 同步發佈、Desktop Electron session title hover 與 single-click 改進、SDK v2 SSE streams 修正（V2Event name 保留）、location node 功能重構與獨立分離、stats route 功能完善與 model tier 追蹤、GitHub issue actions 團隊作者自動跳過、client generated files 排除格式化、session runtime operations 恢復、active sessions API 公開 |
...
| v3.11.1 | Multimodal Looker 預覽、GPT-5 xhigh 路由 |
| v3.13.1 | Metis（Plan Consultant）、Agent Orchestration、Session Tools、Think Mode |
| v3.17.0 | 162 releases；更名 oh-my-openagent、OpenCode v1.4.0 最低版本檢查、Doctor 診斷命令、Session Recovery、File Prompts、Model Fallbacks 物件設定、frontend-ui-ux 技能 |
| v3.17.3 | 164 releases；replace_plan 支援、CLA 貢獻者授權協議、PostHog 匿名 Telemetry、Sisyphus Labs 產品化等待名單 |
| v3.17.10 | 168 releases、55.1k ⭐、199 貢獻者；GPT-5.5 native prompt drafts、npm OIDC CI、auto-update-checker 修正、maxDescendants 移除 |
| v4.0.0 | **重大版本**；Team Mode 正式發佈——Lead agent + 最多 8 個並行成員、tmux 即時視覺化、team_* 工具族群（team_create、team_send_message、team_task_create、team_status）、hyperplan 技能（5 個敵對評論者）、security-research 技能（3 個漏洞獵人 + 2 個 PoC 工程師） |
| v4.1.2 | 177 releases、57.7k ⭐、219 貢獻者；Discipline Agents 模型更新（Sisyphus: claude-opus-4-7/kimi-k2.6/glm-5.1、Hephaestus: gpt-5.5、Prometheus: claude-opus-4-7/kimi-k2.6/glm-5.1）、configurable agent ordering、CDP browser tools、safe deps refresh、ralph-loop compaction continuation ownership guard、.opencode 目錄遷移至 .agents |
| v4.5.12 | 187 releases、60.4k ⭐、268 貢獻者；**Multi-Harness Agent OS 重構**——支援 OpenCode/Codex CLI/Pi 多平台、兩個版本（Ultimate for OpenCode、Light for Codex CLI）、lazycodex 別名、omo-codex Light 可攜版、security-review 內建技能強化、54+ 生命週期掛鉤（61 with Team Mode）、.agents 目錄完整遷移 |
| v4.14.1 | **最新版**，208 releases、64.3k ⭐、290 貢獻者；**Multi-Harness Agent OS 重構完成**——正式支援 OpenCode/Codex/Pi/Claude Code 四平台、LazyCodex Light Edition 正式版（8 核心組件 + 5 MCP）、`packages/omo-opencode` 套件模組化、Telemetry 架構統一（DAU/WAU/MAU）、Codegraph MCP server 新增、共用技能子模組化（frontend）、AST-grep MCP 移除（以 Codegraph 替代）、source-state 修復、budget installer 整合測試 |
...
| v0.11.135 | Templates、Execution Plan Timeline |
| v0.11.191 | Dev Mode 隔離、Cloud Worker、Workspace Switch、Starter Sessions |
| v0.11.206 | 1,055 releases；Ollama 支援、React Session Composer、i18n 五語系（en/ja/zh/vi/pt-BR）、授權變更為 FSL-1.1-MIT、AUR 套件、Debug 匯出、Provider Library 管理 |
| v0.11.207 | 1,057 releases；Composer 精練、Landing 頁面刷新、Catalan 語系新增（i18n 擴展至 6 語系）、microsandbox 沙箱流程、Roadmap 分頁、Node 24 CI 準備 |
| v0.12.x | pnpm workspace 過渡、Electron 始化、self-host guide 簡化 |
| v0.13.0 | 1,087 releases、14.5k ⭐、57 貢獻者；Tauri→Electron 完整遷移、Cloud MCP OAuth Server、Welcome/Onboarding 畫面、AUR PKGBUILD 更新 |
| v0.13.8 | 1,202 releases、15.2k ⭐、61 貢獻者；shadcn/ui skills、Electron browser automation（CDP）、Daytona/devcontainer 全端測試、native main menu、AI Providers 重新命名與 Preferences tab、icon dedup、marketplace 整合、skill hubs 與 shared workspaces（soft-disabled）、10 語系支援（en/fr/es/ca/pt-BR/ja/zh/th/vi/ru）、pnpm minimum release age CI 強制 |
| v0.14.0 | 1,346 releases、15.7k ⭐、62 貢獻者；定位轉型為「open source alternative to Claude Cowork/Codex」、Google Workspace OAuth 身份驗證、Voice mode CDP 音訊檢查、pnpm v11 遷移、內建擴充市集（marketplace）、SCIM/SSO 企業管理流程、新版訊息列表 UI、embedded OpenCode 升級至 v1.15.12、Windows 付費支援計畫 |
| v0.17.4 | **最新版**，1,610 releases、16.5k ⭐、65 貢獻者；品牌正式定位為「Claude Cowork 開源替代品」、SignPath.io 免費程式碼簽署、Enterprise Plan 正式化（SSO/SLA/LTS/Feature Prioritization）、OpenWork Orchestrator CLI 獨立套件（`openwork-orchestrator`）、Docker images 發佈（eval-vnc/den-api/charts）、pnpm v10.27.0 + Bun 1.3.9+ 環境要求、Dev Mode 隔離自動啟用（OPENWORK_DEV_MODE）、架構確認仍為 Tauri（非 Electron）、Wayland/Hyprland 相容性修正 |
...
graph TB
    subgraph "介面層（Clients）"
        TUI["TUI（終端機介面）"]
        Desktop["Desktop App"]
        IDE["IDE Extension<br/>（VS Code SDK v1.17.11）"]
        Web["Web 介面"]
        Mobile["遠端操控<br/>（行動裝置）"]
        OW_App["OpenWork Desktop<br/>（Electron App）"]
        Router["OpenCode Router<br/>（WhatsApp/Slack/Telegram）"]
    end
    ...
    subgraph "OpenCode Server 層"
        ...
        SubScout["Scout SubAgent<br/>（子代理 - 外部文件研究）"]
        SysAgents["系統代理<br/>Compaction/Title/Summary"]
        Tools["內建工具 13<br/>bash/edit/write/read/grep/glob..."]
    ...
    subgraph "AI 供應商層"
        Zen["OpenCode Zen"]
        Anthropic["Anthropic<br/>Claude Opus 4.7/Sonnet"]
        OpenAI["OpenAI<br/>GPT-5.5/o1"]
...
OpenCode 內建完整的多代理系統，包含 **5 個內建代理** 和 **3 個隱藏系統代理**：
...
| **Plan** | 分析規劃 | edit/bash 均預設為 ask（需確認） | 探索程式碼庫、設計架構、制定計畫 |

> **注意**：Plan Agent 的 `edit` 權限預設為 `ask`（需確認），`bash` 權限預設也為 `ask`（需確認）。這確保 Plan Agent 在執行任何修改或命令前會先征得您的同意。
...
| 子代理 | 呼叫方式 | 用途 | 特點 |
|--------|----------|------|------|
| **General** | `@general` | 複雜搜尋和多步驟任務 | 通用型子代理，完整工具存取（todo 除外） |
| **Explore** | 自動呼叫 | **唯讀**程式碼庫探索 | 快速找檔案、搜尋關鍵字、回答程式碼問題 |
| **Scout** | `@scout` | 外部文件與依賴研究 | **唯讀**，可 clone 依賴庫至快取、檢查函式庫原始碼 |
...
**Scout SubAgent**（v1.14.x 新增）是一個專門的唯讀代理，用於外部文件與依賴研究：

- 將依賴儲存庫 clone 到 OpenCode 的託管快取中
- 檢查函式庫的原始碼
- 在不修改工作區的情況下將本機程式碼與 upstream 實作交叉比對
- 適用於需要深入了解第三方依賴實作細節的場景
...
|------|------|--------|
| `description` | 代理描述（**必填**） | - |
| `model` | 使用的模型（格式：`provider/model-id`，如 `opencode/gpt-5.1-codex`） | 繼承全域設定 |
| `prompt` | 系統提示詞（支援 `{file:./path}` 語法） | - |
| `temperature` | 溫度 (0.0-1.0)；0.0-0.2 集中確定、0.3-0.5 平衡、0.6-1.0 創意 | 模型預設（多數為 0，Qwen 為 0.55） |
| `top_p` | Top-P 取樣（0.0-1.0） | 模型預設 |
| `steps` | 最大步驟數（取代已棄用的 maxSteps） | 無限制（直到模型停止） |
| `disable` | 停用代理 | `false` |
| `hidden` | 隱藏代理（不顯示於 `@` 自動補全選單，僅對 `mode: subagent` 有效） | `false` |
| `mode` | 代理模式：`primary` / `subagent` / `all` | `all` |
| `color` | 代理顏色（hex 如 `#FF5733` 或主題：`primary`/`accent`/`success`/`warning`/`error`/`info`） | - |
| `tools` | 工具啟用/停用（支援萬用字元如 `mymcp_*`） | - |
| `permission` | 代理專屬權限（覆蓋全域設定） | - |
| `permission.task` | 子代理呼叫權限（控制可透過 Task 工具呼叫哪些子代理，支援 glob 模式） | - |
...
> **提示**：執行 `opencode models` 查看可用模型列表。使用 [OpenCode Zen](https://opencode.ai/docs/zen) 時，可使用 `opencode/gpt-5.1-codex` 格式。
...
OpenCode 內建 13 個工具，讓 AI Agent 能直接操作開發環境：

| 工具名稱 | 功能 | 權限需求 | 說明 |
|----------|------|----------|------|
| `bash` | 執行 Shell 命令 | bash | 執行任意終端機命令 |
| `edit` | 編輯檔案 | edit | 透過精確字串替換修改現有檔案 |
| `write` | 建立/覆蓋檔案 | edit | 建立新檔案或覆蓋現有檔案（受 `edit` 權限控制） |
| `read` | 讀取檔案 | read | 讀取檔案內容，支援指定行範圍 |
| `grep` | 內容搜尋 | grep | 使用正規表示式搜尋檔案內容 |
| `glob` | 檔案搜尋 | glob | 透過模式匹配查找檔案（如 `**/*.ts`） |
| `list` | 列出目錄 | list | 列出指定路徑下的檔案和目錄 |
| `patch` | 套用修補 | edit | 套用 diff 格式的補丁（受 `edit` 權限控制） |
| `lsp` | LSP 工具 | lsp | 語言伺服器功能（實驗性，需設定 `OPENCODE_EXPERIMENTAL_LSP_TOOL=true`） |
| `webfetch` | 擷取網頁 | webfetch | 擷取並讀取網頁內容 |
| `websearch` | 網路搜尋 | websearch | 使用 Exa AI 進行網路搜尋（使用 OpenCode 供應商或設定 `OPENCODE_ENABLE_EXA=1`） |
| `todowrite` | 管理待辦事項 | todowrite | 建立和更新任務清單追蹤進度（子代理預設停用） |
| `question` | 提問使用者 | question | 執行期間向使用者提問，支援多選選項 |
| `skill` | 使用技能 | skill | 載入 SKILL.md 並回傳技能內容 |

> **注意**：`write`、`patch` 工具均受 `edit` 權限控制，該權限涵蓋所有檔案修改操作（`edit`、`write`、`patch`）。`websearch` 無需 API 金鑰，可直接連接 Exa AI 託管 MCP 服務。底層搜尋工具（`grep`、`glob`、`list`）使用 [ripgrep](https://github.com/BurntSushi/ripgrep)，預設遵循 `.gitignore` 規則。

**可用權限清單：**

| 權限 | 比對對象 | 預設值 |
|------|----------|--------|
| `read` | 檔案路徑 | `allow`（`.env` 檔案預設 `deny`） |
| `edit` | 涵蓋 edit/write/patch | `allow` |
| `bash` | 解析後的指令 | `allow` |
| `glob` | 萬用字元模式 | `allow` |
| `grep` | 正規表示式模式 | `allow` |
| `task` | 子代理類型 | `allow` |
...
| `lsp` | LSP 查詢 | `allow` |
| `webfetch` | URL | `allow` |
| `websearch` | 查詢內容 | `allow` |
| `question` | 使用者問答 | `allow` |
| `todowrite` | 待辦事項管理 | `allow`（子代理預設停用） |
| `external_directory` | 工作目錄外的路徑 | `ask` |
| `doom_loop` | 相同工具呼叫重複 3 次 | `ask` |

> **細粒度規則**：所有權限均支援物件語法進行精細控管，規則透過 glob 模式比對評估，**最後比對的規則優先**。常見做法是將 `*` 規則放在最前面，具體規則放在後面。
...
> **注意**：OmO 外掛已正式更名為 `oh-my-openagent`。舊名稱 `oh-my-opencode` 仍可載入但會顯示棄用警告。設定檔同時接受 `oh-my-openagent.json[c]` 與 `oh-my-opencode.json[c]`。

**外掛類型：**

| 類型 | 說明 | 範例 |
|------|------|------|
| npm 外掛 | 從 npm registry 安裝 | `oh-my-openagent`、`opencode-wakatime`、`opencode-gitlab-plugin` |
...
> **注意**：SKILL.md 的 frontmatter 僅識別 `name`（必填）、`description`（必填）、`license`、`compatibility`、`metadata` 欄位。未知欄位會被忽略。`name` 必須僅含小寫字母、數字與連字號，且與目錄名稱一致。
...
| `~/.claude/skills/*/SKILL.md` | 全域（Claude Code 相容） | Claude Code 全域技能 |
| `.agents/skills/*/SKILL.md` | 專案（通用相容） | 通用 Agent 目錄格式 |
| `~/.agents/skills/*/SKILL.md` | 全域（通用相容） | 通用 Agent 全域技能 |
| 外掛攜帶 | 外掛 | OmO 內建技能 |

> **技能發現機制**：OpenCode 會從當前工作目錄向上遍歷至 git 工作樹根目錄，載入所有匹配的 `skills/*/SKILL.md`。全域定義則從 `~/.config/opencode/`、`~/.claude/` 和 `~/.agents/` 中載入。
...
graph TB
    ...
    subgraph "雲端模型供應商"
        ...
        Anthropic["Anthropic<br/>Claude Opus 4.7/Sonnet 4.5"]
...
OpenCode 也提供桌面應用程式（Beta），基於 **Electron** 架構：
...
> **注意**：OpenCode Desktop（Electron）與 OpenWork Desktop（Tauri）是兩個不同產品。OpenCode Desktop 是 OpenCode 自身的 GUI 介面；OpenWork Desktop 是第三方協作平台。
...
OpenCode 提供 **VS Code 擴充（SDK v1.17.11）**：
...
| GitLab Duo | `/connect` → OAuth 或 PAT | Claude 代理模型 |
| Amazon Bedrock | 環境變數 + 設定檔 | `AWS_PROFILE` 或 IAM |
| Azure OpenAI | `/connect` + 環境變數 | 需 `AZURE_RESOURCE_NAME` |
| Azure Cognitive Services | `/connect` + 環境變數 | 需 `AZURE_COGNITIVE_SERVICES_RESOURCE_NAME` |
| Google Vertex AI | 環境變數 | `GOOGLE_CLOUD_PROJECT` |
| Moonshot AI | `/connect` → API Key | Kimi K2 系列 |
| Z.AI | `/connect` → API Key | GLM 系列 |
| DeepSeek | `/connect` → API Key | DeepSeek Reasoner |
| OpenRouter | `/connect` → API Key | 多供應商閘道 |
| Vercel AI Gateway | `/connect` → API Key | 統一端點，按原價計費 |
| Cloudflare AI Gateway | `/connect` → API Token | Unified Billing |
| Helicone | `/connect` → API Key | LLM 可觀測性平台 |
| Hugging Face | `/connect` → Token | 17+ Inference Providers |
| SAP AI Core | `/connect` → Service Key | 40+ 模型，企業級 |
| Groq | `/connect` → API Key | 高速推理 |
| Together AI | `/connect` → API Key | 開源模型託管 |
| Fireworks AI | `/connect` → API Key | Kimi K2 等 |
| Cerebras | `/connect` → API Key | Qwen 3 Coder 480B |
| Ollama（本地） | 設定 `opencode.json` | 免費，離線可用 |
| Ollama Cloud | `/connect` → API Key | 雲端 Ollama 模型 |
| LM Studio（本地） | 設定 `opencode.json` | 免費，GUI 管理 |
| llama.cpp（本地） | 設定 `opencode.json` | 原生 llama-server |
| 302.AI | `/connect` → API Key | 中國 AI 平台 |
| Baseten | `/connect` → API Key | 模型部署平台 |
| Cortecs | `/connect` → API Key | Kimi K2 等 |
| Deep Infra | `/connect` → API Key | 開源模型推理 |
| Firmware | `/connect` → API Key | AI 推理平台 |
| IO.NET | `/connect` → API Key | 17 個最佳化模型 |
| MiniMax | `/connect` → API Key | M2.1 系列 |
| Nebius Token Factory | `/connect` → API Key | Token Factory |
| OVHcloud AI Endpoints | `/connect` → API Key | 歐洲雲端 |
| STACKIT | `/connect` → Token | 主權歐洲基礎設施 |
| Scaleway | `/connect` → API Key | Generative APIs |
| Venice AI | `/connect` → API Key | 隱私優先 |
| xAI | `/connect` → API Key | Grok 系列 |
| ZenMux | `/connect` → API Key | 多供應商路由 |
| 自訂提供商 | `/connect` → Other | 任何 OpenAI 相容 API |
...
> **提示**：OpenCode 的 `edit` 工具支援一次修改多個檔案。AI Agent 會自動選擇最適合的工具。
...
### 5.8 使用 Explore / Scout SubAgent 探索程式碼庫與外部文件
...
#### Scout SubAgent（v1.14.x+）

Scout SubAgent 是 v1.14.x 新增的 **只讀外部研究** 子代理，專門用於查詢外部文件與相依套件：

| 特性 | 說明 |
|------|------|
| 只讀操作 | 不會修改任何檔案 |
| 外部文件研究 | 搜尋 npm、PyPI、Maven 等套件文件 |
| 相依套件分析 | 查詢版本相容性、API 變更 |
| 獨立上下文 | 不與主對話共用上下文視窗 |
| 權限 | 需要 `external_directory` 權限 |
...
> **Explore vs Scout**：Explore 專注於分析「本地程式碼庫」，Scout 專注於研究「外部文件與套件」。兩者皆為只讀，可並行使用。
...
| 場景 | 建議模型 | 理由 |
|------|----------|------|
| 系統架構設計 | Claude Opus 4.7 / GPT-5.5 | 複雜推理能力 |
...
| 安全修正 | 漏洞修補完整性、OWASP 合規 | Opus 4.7 |
...
OpenCode 使用 `permission` 設定來決定某個操作是否應自動執行、提示審批，還是被阻止。從 `v1.1.1` 開始，舊版 `tools` 布林設定已合併到 `permission` 中（仍保持向後相容）。

#### 7.5.1 完整權限列表

| 權限 | 說明 | 比對對象 | 預設值 |
|------|------|----------|--------|
| `read` | 讀取檔案 | 檔案路徑 | `allow`（`.env` 檔案為 `deny`） |
| `edit` | 所有檔案修改（涵蓋 `edit`、`write`、`patch`） | 檔案路徑 | `allow` |
| `bash` | 執行 shell 命令 | 解析後的命令 | `allow` |
| `glob` | 檔案萬用字元比對 | 萬用字元模式 | `allow` |
| `grep` | 內容搜尋 | 正規表示式 | `allow` |
| `task` | 啟動子代理 | 子代理類型 | `allow` |
| `skill` | 載入技能 | 技能名稱 | `allow` |
| `lsp` | LSP 查詢 | 目前不支援細粒度 | `allow` |
| `webfetch` | 擷取 URL | URL | `allow` |
| `websearch` | 網頁搜尋 | 查詢內容 | `allow` |
| `question` | 向使用者提問 | 問題內容 | `allow` |
| `todowrite` | 管理待辦事項 | 任務清單 | `allow`（子代理預設停用） |
| `external_directory` | 存取專案工作目錄外的路徑 | 路徑 | `ask` |
| `doom_loop` | 同一工具呼叫以相同輸入重複 3 次觸發 | - | `ask` |

#### 7.5.2 細粒度權限控制（物件語法）

可使用物件語法根據工具輸入套用不同操作，支援萬用字元（`*` 比對零或多個字元、`?` 精確比對一個字元）和 `~`/`$HOME` 主目錄展開：
...
> **規則評估順序**：最後比對的規則優先。建議將 `"*"` 放最前面，具體規則放後面。
...
|------|------|
| **once** | 僅批准本次請求 |
| **always** | 批准與建議模式比對的後續請求（當前工作階段有效） |
| **reject** | 拒絕請求 |

> `always` 所批准的模式集合由工具提供（例如 bash 審批通常會將安全命令前綴如 `git status*` 加入白名單）。

#### 7.5.4 代理專屬權限

代理權限會與全域設定合併，代理規則優先。支援 JSON 設定和 Markdown 代理中定義：
...
每個 `SKILL.md` 必須以 YAML frontmatter 開頭，僅識別以下欄位（未知欄位會被忽略）：

| 欄位 | 必填 | 說明 |
|------|------|------|
| `name` | ✅ | 技能名稱（1-64 字元，小寫字母數字，可用 `-` 分隔） |
| `description` | ✅ | 技能描述（1-1024 字元） |
| `license` | ❌ | 授權類型 |
| `compatibility` | ❌ | 相容性標記 |
| `metadata` | ❌ | 字串到字串的自訂映射 |

> **注意**：`name` 必須與包含 `SKILL.md` 的目錄名稱一致，正規表示式：`^[a-z0-9]+(-[a-z0-9]+)*$`
...
OpenCode 會從當前工作目錄向上遍歷至 git 工作樹根目錄，搜尋以下位置：
...
OpenCode 的規則系統讓你為 AI 代理定義行為準則，類似 Cursor 的規則功能：

**規則檔案位置與優先順序：**

| 位置 | 範圍 | 說明 |
|------|------|------|
| `AGENTS.md`（專案根目錄） | 專案 | 專案說明和規則（優先使用） |
| `CLAUDE.md`（若未停用） | 專案 | Claude Code 相容（`AGENTS.md` 不存在時備援） |
| `~/.config/opencode/AGENTS.md` | 全域 | 個人規則（不提交 Git） |
| `~/.claude/CLAUDE.md`（若未停用） | 全域 | 全域 Claude Code 相容 |

> **優先順序**：本機檔案 > 全域檔案。同類別中 `AGENTS.md` 優先於 `CLAUDE.md`。

**自訂指令（opencode.json）：**

可在 `opencode.json` 中指定額外規則檔案，支援 glob 模式和遠端 URL：
...
> 遠端指令的擷取逾時為 5 秒。所有指令檔案都會與 `AGENTS.md` 合併。
...
```bash
# 方法一：安裝指定版本
npm install -g opencode-ai@<指定版本>

# 方法二：Homebrew 回滾
brew uninstall opencode
brew install anomalyco/tap/opencode@<指定版本>

# 方法三：使用 docker 固定版本
docker run -it ghcr.io/anomalyco/opencode:<指定版本>
```
...
| Claude Opus 4.7 API（架構師用） | ~$200/人/月 | 3 | $600 |
...
| npm 套件名 | `oh-my-openagent`（舊名 `oh-my-opencode` 過渡期仍可用） |
| CLI 入口 | `ultrawork` / `ulw` / `lazycodex`（Light 版） |
| 前身 | `oh-my-opencode`（ohmo）→ 已更名為 `oh-my-openagent` |
| 官方網站 | [omo.dev](https://omo.dev) |
| 商業版 | **Sisyphus Labs**（企業級支援） |
| 架構 | **Multi-Harness Agent OS**（支援 OpenCode/Codex CLI/Pi/Claude Code） |
...
> **品牌說明**：Oh My OpenAgent 已將 npm 套件名正式更名為 `oh-my-openagent`（舊名 `oh-my-opencode` 過渡期仍可安裝）。GitHub repo 與官方品牌統一使用 `oh-my-openagent`。CLI 入口為 `ultrawork` / `ulw`（Ultimate 版）或 `lazycodex`（Light 版）。v4.5 起支援 Multi-Harness Agent OS 架構，同時支援 OpenCode、Codex CLI 與 Pi 等多種 harness。
...
graph TB
    subgraph "Discipline Agents 編排架構"
        ...
        subgraph "主編排器"
            Sisyphus["🏔️ Sisyphus<br/>主編排器<br/>claude-opus-4-7 / kimi-k2.6 / glm-5.1"]
        end

        subgraph "專業代理"
            Hephaestus["🔨 Hephaestus<br/>深度工匠<br/>gpt-5.5"]
            Prometheus["🔥 Prometheus<br/>策略規劃<br/>claude-opus-4-7 / kimi-k2.6 / glm-5.1"]
...
| 代理 | 角色 | 預設模型 | 職責 |
|------|------|----------|------|
| **Sisyphus** 🏔️ | 主編排器 | `claude-opus-4-7` / `kimi-k2.6` / `glm-5.1` | 任務分解、子代理調度、品質控管 |
| **Hephaestus** 🔨 | 深度工匠 | `gpt-5.5` | 複雜程式碼實作、長時間深度工作（The Legitimate Craftsman） |
| **Prometheus** 🔥 | 策略規劃 | `claude-opus-4-7` / `kimi-k2.6` / `glm-5.1` | 多方案分析、風險評估、長期規劃 |
| **Oracle** 🔮 | 架構/除錯 | 按需選擇 | 架構決策、複雜除錯 |
| **Librarian** 📚 | 文件搜尋 | 快速模型 | 搜尋官方文件、API 參考 |
| **Explore** 🔎 | 程式碼探索 | 快速模型 | 快速程式碼庫 grep 搜尋（唯讀） |
| **Multimodal Looker** 🔍 | 視覺工程 | 多模態模型 | 截圖轉程式碼、UI 分析（v3.12+） |
| **Metis** 🦉 | 規劃顧問 | Thinking Model | 諮詢建議、風險評估（v3.12+） |
...
```text
任務類型 → 自動選擇最適模型
├── 複雜程式碼實作 → Hephaestus（gpt-5.5）
├── 架構設計與規劃 → Prometheus（claude-opus-4-7 / kimi-k2.6 / glm-5.1）
├── 架構除錯 → Oracle（按需）
├── 文件搜尋 → Librarian（快速模型）
├── 程式碼探索 → Explore（快速模型，唯讀）
└── 協調與編排 → Sisyphus 自身（claude-opus-4-7）
```
...
OmO 的模型路由策略讓不同任務自動使用最適合的模型。Sisyphus 不直接選擇模型，而是選擇**任務分類（Category）**，由 Harness 自動映射至對應模型：

**分類路由機制：**

| 分類 | 適用場景 | 預設模型 |
|------|----------|----------|
| `visual-engineering` | 前端、UI/UX、設計相關 | 視覺模型 |
| `deep` | 自主研究 + 端到端執行 | `gpt-5.5` |
| `quick` | 單檔案修改、修正錯字 | 快速模型 |
| `ultrabrain` | 高難度邏輯、架構決策 | `gpt-5.5 xhigh` |

> **關鍵原則**：Agent 宣告工作類型，Harness 選擇對應模型。開發者無需手動干預。

```mermaid
graph TB
    Task["任務輸入"]

    Router["Sisyphus<br/>分類路由器"]

    Cat1["visual-engineering<br/>（前端/UI/UX）"]
    Cat2["deep<br/>（自主研究+執行）"]
    Cat3["quick<br/>（單檔案/快速修正）"]
    Cat4["ultrabrain<br/>（高難度邏輯/架構）"]

    M1["claude-opus-4-7 / kimi-k2.6"]
    M2["gpt-5.5"]
    M3["快速模型"]
    M4["gpt-5.5 xhigh"]
...
| 視覺工程 | ❌ | ✅ Multimodal Looker（v3.12+） |
| 規劃諮詢 | ❌ | ✅ Metis（v3.12+） |
| ultrabrain 模式 | ❌ | ✅ GPT-5.5 xhigh（v3.13+） |
| Session 歷程分析 | ❌ | ✅ Session Tools（v3.13+） |
| 顯式推理 | ❌ | ✅ Think Mode（v3.13+） |
| Hook 系統 | 基本 | ✅ 25+ 內建 Hooks |
...
model_routing:
  ...
  rules:
    ...
    - task_type: planning
      model: claude-opus-4-7   # 規劃用大模型
```

---

### 10.23 Multimodal Looker 代理（v3.12+ 新增）

**Multimodal Looker** 是 OmO v3.12 引入的視覺工程代理，能夠分析截圖、設計稿、UI 原型並自動產生對應的程式碼：

```mermaid
graph TB
    subgraph "Multimodal Looker 工作流程"
        Input["輸入<br/>截圖 / Figma / 手繪稿"]
        Looker["🔍 Multimodal Looker<br/>視覺分析代理"]
        Analysis["語意分析<br/>元件辨識 / 佈局解析 / 互動推斷"]
        Code["程式碼產生<br/>React / Vue / HTML"]
        Review["Sisyphus 審查<br/>品質驗證"]
    end
...
| 功能 | 說明 |
|------|------|
| 截圖轉程式碼 | 上傳 UI 截圖，自動產生對應的前端元件 |
| Figma 整合 | 連接 Figma 設計稿，擷取設計 Token 並產生程式碼 |
| 差異比對 | 比較設計稿與實際實作的視覺差異 |
| 響應式生成 | 自動產生桌面、平板、手機三種佈局 |
| 無障礙標注 | 自動加入 ARIA 標籤和語意化 HTML |
...
**Agent Orchestration 分類中的位置：**

Multimodal Looker 屬於 **visual-engineering** 類別，與其他類別的關係：

| 類別 | 代表代理 | 適用場景 |
|------|----------|----------|
| **visual-engineering** | Multimodal Looker | 視覺設計轉程式碼、UI 分析 |
| **deep** | Hephaestus | 複雜程式碼實作、長時間深度工作 |
| **quick** | Librarian / 快速代理 | 文件搜尋、簡單修改 |
| **ultrabrain** | Sisyphus + GPT-5.5 xhigh | 超複雜推理、跨領域分析 |

---

### 10.24 Metis 代理——規劃顧問（v3.12+ 新增）

**Metis**（命名自希臘智慧女神）是 v3.12 新增的 **Plan Consultant** 代理，專門負責在 Prometheus 規劃前提供諮詢意見：

```mermaid
graph TB
    User["使用者需求"]
    Metis["🦉 Metis<br/>Plan Consultant<br/>規劃諮詢"]
    Prometheus["🔥 Prometheus<br/>策略規劃"]
    Sisyphus["🏔️ Sisyphus<br/>執行編排"]

    User --> Metis
    Metis -->|"策略建議 + 風險評估"| Prometheus
    Prometheus -->|"詳細執行計畫"| Sisyphus
    Sisyphus -->|"任務分配"| Agents["Discipline Agents"]
```

| 比較 | Metis | Prometheus |
|------|-------|------------|
| 角色 | 諮詢顧問（Advisory） | 策略規劃（Planning） |
| 輸出 | 建議、風險、替代方案 | 詳細步驟、工時估算 |
| 何時觸發 | 複雜需求進入前 | Metis 諮詢後 |
| 模型偏好 | Thinking Model（高推理） | claude-opus-4-7 |
...
### 10.25 GPT-5.5 xhigh 路由與 ultrabrain 模式（v3.13+ 新增）

OmO v3.13 引入了 **ultrabrain** 路由等級，專為超複雜任務設計：

```mermaid
graph TB
    subgraph "Agent Orchestration 四大類別"
        VE["🎨 visual-engineering<br/>Multimodal Looker"]
        Deep["🔨 deep<br/>Hephaestus<br/>gpt-5.5"]
        Quick["⚡ quick<br/>Librarian<br/>claude-haiku-4-5"]
        Ultra["🧠 ultrabrain<br/>Sisyphus<br/>GPT-5.5 xhigh"]
    end

    Router["IntentGate<br/>路由決策"]
    Router --> VE
    Router --> Deep
    Router --> Quick
    Router --> Ultra
...
| 特點 | 說明 |
|------|------|
| 模型 | GPT-5.5 xhigh（最高推理能力） |
| 上下文 | 最大可用上下文視窗 |
| Token 消耗 | 極高（建議僅用於關鍵任務） |
| 適用場景 | 跨領域架構設計、安全審計、遺留系統分析 |
| 自動降級 | 若 xhigh 不可用，自動降級為 claude-opus-4-7 |
...
### 10.26 Session Tools——歷程分析（v3.13+ 新增）

OmO v3.13 新增 **Session Tools**，讓使用者和代理能夠回顧、搜尋和分析過去的對話歷程：

| 工具 | 功能 | 使用方式 |
|------|------|----------|
| `session list` | 列出所有歷史 Session | `/session list --last 30d` |
| `session read` | 讀取特定 Session 完整內容 | `/session read <session-id>` |
| `session search` | 搜尋 Session 內容 | `/session search "微服務拆分"` |
| `session analyze` | 分析 Session 模式與效率 | `/session analyze --report` |
...
### 10.27 Think Mode（v3.13+ 新增）

**Think Mode** 讓代理在回應前進行「顯式推理」，將思考過程透明化：
...
| 回應速度 | 快 | 較慢（需要推理時間） |
| 透明度 | 僅顯示結果 | 顯示完整推理過程 |
| Token 消耗 | 標準 | +30-50%（推理 token） |
| 推薦場景 | 簡單任務 | 複雜決策、架構設計、審計 |

---

### 10.28 OmO v3.13 其他更新

**25+ 內建 Hooks：**

OmO v3.13 擴充了 Hook 系統，現在提供 25+ 內建 hooks：

| Hook 類型 | 範例 | 觸發時機 |
|-----------|------|----------|
| `pre-edit` | 編輯前檢查 | 每次檔案編輯前 |
| `post-edit` | 編輯後驗證 | 每次檔案編輯後 |
| `pre-commit` | 提交前品質檢查 | git commit 前 |
| `session-start` | Session 初始化 | 啟動新 Session 時 |
| `session-end` | Session 總結 | 結束 Session 時 |
| `agent-switch` | 代理切換記錄 | 切換代理時 |
| `error-recovery` | 錯誤自動恢復 | 代理遇到錯誤時 |
| `budget-alert` | Token 預算警告 | 接近預算上限時 |

**omx 狀態檔：**

OmO 使用 `.omx` 狀態檔來追蹤代理的工作進度：
...
**oh-my-openagent.jsonc 設定檔支援：**

除了 YAML 設定外，OmO 支援 JSONC 格式設定檔（推薦使用 `oh-my-openagent.jsonc`，舊名 `oh-my-opencode.jsonc` 過渡期仍可載入）：
...
- 官方網站：[ohmyopenagent.com](https://ohmyopenagent.com)
- **Sisyphus Labs**：OmO 的商業化版本（productized），提供企業級支援、託管服務和 SLA 保障
- 文件與社群：透過官方網站存取完整文件、討論區和插件市場

---

### 10.29 OmO v3.14-v3.17.10 更新摘要

OmO 自 v3.13 至 v3.17.10 持續快速迭代，以下為關鍵更新：

| 版本 | 重點更新 |
|------|----------|
| v3.14 | 套件更名為 `oh-my-openagent`，相容層仍接受 `oh-my-opencode` |
| v3.15 | OpenCode v1.4.0 最低版本檢查（安裝時自動驗證）；Doctor 診斷命令 |
| v3.16 | Session Recovery 自動恢復（上下文超限、API 失敗自動重試）；File Prompts（`file://` 語法） |
| v3.17.0 | Model Fallbacks 混合格式（純字串與物件設定共存）；Skills 新增 `frontend-ui-ux`；效能改進 |
| v3.17.1 | Orchestration 文件更新；dev 分支合併修正（openclaw 分支整合）；CLA 貢獻者授權協議引入 |
| v3.17.2 | 穩定性修正；Telemetry 文件與法律文件（Privacy Policy、Terms of Service）完善 |
| v3.17.3 | `replace_plan` 支援（設定 `true` 時隱藏原生 Plan Agent）；ad-hoc signing darwin binary 修正；AGENTS.md 生成日期更新 |
| v3.17.4-v3.17.9 | 穩定性修正與改進；obsolete `maxDescendants` config 移除；auto-update-checker 修正（偏好已載入模組的 package.json）；plugin bundle 外部化 zod 防止雙實例問題 |
| v3.17.10 | 最新版（168 releases、55.1k ⭐、199 貢獻者）；GPT-5.5 native prompt drafts；npm OIDC exchange CI 改進（201 視為成功）；CLA 簽署流程優化 |

**Sisyphus Labs 產品化（v3.17+ 新動態）：**

OmO 團隊正在開發 Sisyphus Labs——一個完全產品化的 Sisyphus 代理版本，定位為「未來前沿代理」：

- 官網：[sisyphuslabs.ai](https://sisyphuslabs.ai/)
- 提供等待名單註冊
- 與開源 OmO 外掛互補，提供企業級服務

**PostHog 匿名 Telemetry（v3.17+）：**

OmO 預設啟用匿名遙測以改善安裝和運行時可靠性：
...
- 使用 PostHog 平台，僅傳輸雜湊安裝識別碼（非原始主機名稱）
- 相關法律文件：[Privacy Policy](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/legal/privacy-policy.md)、[Terms of Service](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/legal/terms-of-service.md)

**CLA 貢獻者授權協議（v3.17.1+）：**

所有 PR 現在需要簽署 Contributor License Agreement（CLA），透過 GitHub Actions 自動驗證。

> **企業注意**：企業在評估 OmO 外掛時，應注意其 Telemetry 預設啟用的特性。建議在企業環境中設定 `OMO_SEND_ANONYMOUS_TELEMETRY=0` 以符合資料治理要求。
...
**Session Recovery（v3.16+）：**

OmO 現在能自動從以下錯誤場景恢復：

| 錯誤場景 | 恢復策略 |
|----------|----------|
| 上下文視窗超限 | 自動壓縮歷史，重新載入關鍵上下文 |
| API 速率限制 | 等待後自動重試，切換備用模型 |
| 模型回應超時 | 降級至更快的模型完成任務 |
| Session 中斷 | 自動保存進度，重啟後從斷點繼續 |
...
| 技能 | 說明 | 版本 |
|------|------|------|
| `playwright` | 瀏覽器自動化測試 | v3.10+ |
| `git-master` | 原子提交、rebase 手術 | v3.10+ |
| `frontend-ui-ux` | 設計優先的 UI 開發 | v3.17+ |

---

### 10.30 OmO v4.0-v4.5.12 更新摘要（Team Mode 與 Multi-Harness OS 重大版本）

OmO 在 v4.0 引入 **Team Mode** 多代理並行系統，v4.5 則實現 **Multi-Harness Agent OS 重構**，以下為完整更新：

#### Team Mode（v4.0 核心功能）

Team Mode 將 OmO 從「一個代理帶子代理」升級為真正的多代理系統：

| 特性 | 說明 |
|------|------|
| Lead Agent | 主編排代理，負責任務分派與協調 |
| 並行成員 | 最多 **8 個**類別專業化成員同時運行 |
| tmux 視覺化 | 即時觀看每個成員的工作進度（focus + grid 視窗） |
| team_* 工具族群 | `team_create`、`team_send_message`、`team_task_create`、`team_status` 等 |
...
> **注意**：Team Mode 預設為關閉。重啟 opencode 後 `team_*` 工具族群才會解鎖。

**內建 Team Mode 技能：**

| 技能 | 說明 | 成員組成 |
|------|------|----------|
| `hyperplan` | 超級計畫驗證 | 5 個敵對評論者從正交角度拆解你的計畫 |
| `security-research` | 安全研究 | 3 個漏洞獵人 + 2 個 PoC 工程師並行審計 |

#### Discipline Agents 模型更新

| 代理 | 角色 | 預設模型 |
|------|------|----------|
| **Sisyphus** | 主編排器 | `claude-opus-4-7` / `kimi-k2.6` / `glm-5.1` |
| **Hephaestus** | 自主深度工匠 | `gpt-5.5` |
| **Prometheus** | 策略規劃器 | `claude-opus-4-7` / `kimi-k2.6` / `glm-5.1` |
| **Oracle** | 架構/除錯 | 繼承路由配置 |
| **Librarian** | 文件搜尋 | 繼承路由配置 |
| **Explore** | 快速程式碼 grep | 繼承路由配置 |
| **Multimodal Looker** | 視覺分析 | 繼承路由配置 |

> **重要變更**：Anthropic 已封鎖 OpenCode 使用其 API，因此 Hephaestus 被稱為「The Legitimate Craftsman」（合法工匠），使用 GPT-5.5 作為預設模型。OmO 官方建議使用 Kimi K2.6 + GPT-5.5 組合即可超越原版 Claude Code 體驗。

#### Agent Orchestration 分類路由更新

| 分類 | 用途 | 路由模型 |
|------|------|----------|
| `visual-engineering` | 前端、UI/UX、設計 | 自動選擇最佳視覺模型 |
| `deep` | 自主研究 + 執行 | Hephaestus (GPT-5.5) |
| `quick` | 單檔變更、錯字修正 | 快速模型 |
| `ultrabrain` | 困難邏輯、架構決策 | GPT-5.5 xhigh |

#### 推薦訂閱組合

OmO 官方推薦的最低成本訂閱組合（使用 `ultrawork` 即可自動運作）：

| 服務 | 月費 | 用途 |
|------|------|------|
| ChatGPT Subscription | $20 | GPT-5.5 存取 |
| Kimi Code Subscription | $19 | Kimi K2.6 存取 |
| GLM Coding Plan | $10 | GLM-5.1 存取 |

#### 其他 v4.x 更新

| 更新項目 | 說明 |
|----------|------|
| Configurable agent ordering | 可自訂代理排序 |
| CDP browser tools | Chrome DevTools Protocol 整合，支援瀏覽器自動化 |
| `.opencode` → `.agents` 目錄遷移 | 設定目錄正式從 `.opencode` 遷移至 `.agents` |
| Safe deps refresh | 自動安全依賴更新機制 |
| ralph-loop compaction guard | Ralph Loop 壓縮延續所有權防護 |
| 54+ lifecycle hooks | 包含 Team Mode 共 61 個生命週期鉤子 |
| `disabled_hooks` 設定 | 可個別停用不需要的鉤子 |

#### Multi-Harness Agent OS 重構（v4.5+ 新增）

OmO v4.5 實現了重大架構重構，從單一 OpenCode 外掛演進為支援多平台的 **Agent OS**：

| 版本 | 名稱 | 目標平台 | 說明 |
|------|------|----------|------|
| **Ultimate** | `oh-my-openagent` | OpenCode | 完整功能版，包含所有技能與 Team Mode |
| **Light** | `omo-codex` | Codex CLI | 可攜式精簡版，適用於 Codex CLI 環境 |

**安裝 Light 版本：**

```bash
# 安裝 omo-codex Light 版
# 可透過 lazycodex 別名啟動
lazycodex
```
...
```mermaid
graph TB
    subgraph "OmO Multi-Harness Agent OS"
        Core["OmO Core<br/>共用元件"]
        Ultimate["Ultimate Edition<br/>oh-my-openagent<br/>（OpenCode 專用）"]
        Light["Light Edition<br/>omo-codex<br/>（Codex CLI 專用）"]
        Pi["Pi Harness<br/>（未來平台）"]
    end
...
> **重要**：這一重構代表 OmO 不再僅是 OpenCode 的外掛，而是演進為獨立的 Agent OS 平台，可在多個 AI 編碼工具上運行。

---

### 10.31 OmO v4.6-v4.14.1 更新摘要（Multi-Harness 完成與 LazyCodex 正式版）

OmO 自 v4.5 之後持續快速迭代，至 **v4.14.1**（2026 年 6 月）已累計 **208 releases**、**64.3k Stars**、**290 貢獻者**。以下為關鍵更新：

#### Multi-Harness Agent OS 重構完成

v4.5 啟動的架構重構已在 v4.14 正式完成。OmO 現支援 **四大平台**：

| 平台 | 版本名稱 | 安裝方式 | 說明 |
|------|----------|----------|------|
| **OpenCode** | Ultimate Edition | `bunx oh-my-openagent install` | 完整功能：11 代理、54+ hooks、Team Mode、所有 MCP |
| **Codex CLI** | Light Edition (LazyCodex) | `npx lazycodex-ai install` | 8 核心組件 + 5 MCP，適用 OpenAI Codex CLI |
| **Pi** | Pi Harness | 開發中 | 未來平台支援 |
| **Claude Code** | 相容層 | hooks/commands/skills 完整相容 | 所有 Claude Code 設定可直接使用 |

**雙版本安裝：**

```bash
# 只安裝 Ultimate（OpenCode 專用）
bunx oh-my-openagent install

# 只安裝 Light（Codex CLI 專用）
...
#### LazyCodex Light Edition 正式版

Light Edition 為 Codex CLI 量身打造的精簡版，包含以下 **8 核心組件**：

| 組件 | 說明 |
|------|------|
| `rules` | 專案規則與 AGENTS.md 自動載入 |
| `comment-checker` | 防止 AI 生成低品質註解 |
| `git-bash` | Git 操作與 Bash 工具 |
| `lsp` | LSP 整合（rename、diagnostics、navigation） |
| `ultrawork` | 一鍵啟動所有代理 |
| `ulw-loop` | 持久多目標編排與證據審計 |
| `start-work-continuation` | 工作延續機制 |
| `telemetry` | 匿名使用統計（可停用） |

**Light Edition 內建 MCP 伺服器：**

| MCP | 用途 |
|-----|------|
| `grep_app` | GitHub 程式碼搜尋 |
| `context7` | 官方文件查詢 |
| `codegraph` | 程式碼知識圖譜 |
| `git_bash` | Git 與 Bash 操作 |
| `lsp` | LSP 伺服器功能 |

#### 套件重構（packages/omo-opencode）

OmO 完成了重大套件重構，將外掛原始碼獨立至 `packages/omo-opencode` 模組：

```
oh-my-openagent/
├── packages/
│   ├── omo-opencode/        ← 核心外掛模組（新分離）
│   ├── lazycodex/           ← Codex Light installer
│   └── shared-skills/       ← 跨平台共用技能
├── .agents/                 ← 代理定義目錄
├── .omo/                    ← OmO 設定與狀態
├── docs/                    ← 文件
└── tests/                   ← 測試
...
| 版本 | 事件名稱 | 來源 | 頻率 |
|------|----------|------|------|
| Ultimate | `omo_daily_active` | `plugin_loaded` / `run_started` | 每 UTC 日每機器最多一次 |
| Light | `omo_codex_daily_active` | `install_completed` / `session_start` | 每 UTC 日每機器最多一次 |
...
# Ultimate
export OMO_DISABLE_POSTHOG=1
# 或在設定中：{"telemetry": false}

# Light (Codex)
export OMO_CODEX_DISABLE_POSTHOG=1
```

> 使用 SHA256 雜湊的安裝標識符（非原始主機名），且 PostHog 不建立個人檔案。

#### Codegraph MCP Server

v4.10+ 新增 **Codegraph MCP server**，提供程式碼知識圖譜功能：

- 自動索引專案結構與依賴關係
- 支援跨檔案符號解析
- 透過 `.codegraph/` 目錄管理索引
- 在 Light 與 Ultimate 兩版本均可使用

#### 共用技能子模組化（shared-skills）

前端相關技能（如 `designpowers`、`frontend`）已重構為共用子模組，可跨平台重用：

```jsonc
// .opencode/oh-my-openagent.jsonc
{
  "skills": {
    "playwright": true,     // 瀏覽器自動化
    "git-master": true,     // 原子提交、rebase
    "frontend": true        // 設計優先 UI（共用技能）
  }
}
```
...
| 版本 | 更新項目 |
|------|----------|
| v4.6 | source-state 修復、event handler 迴歸修正 |
| v4.7 | 前端子模組實體化、共用腳本清理 |
| v4.8 | devcontainer 共用設定、codex/cursor/claude 統一接線 |
| v4.9 | AST-grep MCP server 移除（以 Codegraph 替代） |
| v4.10 | Codegraph MCP 新增、unsafe test value type 嚴格化 |
| v4.11 | Web terminal 修復、hashline 測試重構 |
| v4.12 | Telemetry 架構統一、LazyCodex marketplace 穩定 |
| v4.13 | budget installer 整合測試、codex node runtime notices |
| v4.14 | PR 自動化改善、sparkshell 移除、AGENTS.md 精簡 |

#### 卸載指令更新

```bash
# 卸載 Ultimate（OpenCode）
...
**OpenWork** 是 OpenCode 生態系中的 **桌面 GUI 協作平台**，定位為開源版的 Claude Cowork / Codex 替代品（desktop app）。OpenWork 讓非終端機使用者也能享受 AI 編碼代理的能力，並提供團隊級的協作功能。
...
| 版本發佈 | **1,610+** |
| 授權 | **MIT** |
| 技術堆疊 | TypeScript 83.1% / JavaScript 12.0% / CSS 1.7% / Swift 1.2% / Shell 1.1% / MDX 0.8% |
| OpenCode 版本 PIN | 透過 `constants.json` 固定（當前內嵌 v1.17.x） |
| 官方網站 | [openworklabs.com](https://openworklabs.com) |
| Desktop Framework | **Tauri**（搭配 WebKitGTK；OpenCode Desktop 使用 Electron） |
| 應用程式語言 | 英文、法文、西班牙文、加泰隆尼亞文、巴西葡萄牙文、日文、簡體中文、泰文、越南文、俄文（10 語系） |
| Windows 支援 | 透過付費支援計畫提供（[openworklabs.com/pricing](https://openworklabs.com/pricing#windows-support)） |
| 企業方案 | 提供 Enterprise 版本，含 SSO、SLA、LTS、Feature Prioritization |
| 程式碼簽署 | [SignPath.io](https://about.signpath.io/) 免費提供，憑證由 SignPath Foundation 頒發 |
...
```mermaid
graph TB
    subgraph "OpenWork Desktop（Electron App）"
        UI["GUI 介面"]
...
| 功能 | 說明 | 狀態 |
|------|------|------|
| 桌面應用 | Electron 桌面應用（v0.13.0 起從 Tauri 遷移） | ✅ 穩定 |
| 對話介面 | 友善的 Chat UI | ✅ 穩定 |
| 技能管理器 | 安裝、管理、使用技能 | ✅ 穩定 |
...
| Dev Mode | 開發模式隔離環境 | ✅ 穩定 |
| Templates 重播 | 儲存並重新執行工作流程 | ✅ 穩定 |
| Execution Plan Timeline | 任務時間軸視覺化 | ✅ 穩定 |
| Cloud Worker | 雲端計算委託架構 | ✅ 穩定 |
| Workspace Switch | 快速工作空間切換 | ✅ 穩定 |
| Starter Sessions | 預設工作空間模板 | ✅ 穩定 |
| Den (Daytona) | Docker 開發環境整合 | ✅ 穩定 |
...
下載位址：[openworklabs.com/download](https://openworklabs.com/download) 或 [GitHub Releases](https://github.com/different-ai/openwork/releases)
...
> **注意**：Windows 下載目前透過 [openworklabs.com/pricing#windows-support](https://openworklabs.com/pricing#windows-support) 的付費支援計畫提供。macOS 和 Linux 可直接免費下載。
...
**桌面應用架構（v0.13.0 起遷移至 Electron）：**

> **重要變更**：OpenWork v0.13.0 已從 Tauri 遷移至 Electron。此遷移帶來更好的跨平台相容性與外掛生態系統整合。以下為新架構。
...
graph TB
    ...
    subgraph "Electron 橋接層"
        IPC["IPC 通訊"]
        Events["Event System"]
        Preload["Preload Scripts"]
    end

    subgraph "後端（Main Process）"
        Core["核心邏輯（Node.js）"]
        FS["檔案系統存取"]
        Process["程序管理"]
        HTTP["HTTP Client"]
...
| 橋接 | Electron IPC | 前端與後端通訊 |
| 後端 | Node.js（Electron Main Process） | 程序管理、檔案操作 |
| 引擎 | OpenCode Core | AI 代理功能 |

> **遷移說明**：v0.13.0 之前使用 Tauri（Rust 後端 + WebView），遷移至 Electron 後改用 Node.js 主程序。當前技術比例：TypeScript 85.6%、JavaScript 9.2%、CSS 2.0%、Swift 1.3%、Shell 1.3%、MDX 0.6%。
...
|----------|------|
| 本地執行 | 所有程式碼處理在本地進行 |
| 沙箱模式 | Electron 的 Renderer Process 有嚴格的沙箱限制 |
| 權限控制 | 繼承 OpenCode 的權限系統 |
| API Key 保護 | 使用作業系統的 Keychain/Credential Manager |
| 更新驗證 | Electron 更新器驗證簽章 |
| **localhost 綁定** | v0.11.160+ 預設僅綁定 localhost，防止外部存取 |

---

### 11.12 Dev Mode 隔離（v0.11.160+ 新增）

OpenWork v0.11.160 引入了 **Dev Mode**，讓開發者能在隔離環境中安全測試：
...
| 隔離資料 | 使用獨立的設定檔和工作目錄 |
| 安全沙箱 | 不影響正式環境的設定和資料 |
| 偵錯工具 | 啟用 DevTools、詳細日誌 |
| 熱重載 | 前端程式碼變更自動重載 |
| localhost 限制 | 預設僅綁定本地 localhost，不對外暴露 |

---

### 11.13 Templates 儲存與重播（v0.11.170+ 新增）

OpenWork 的模板系統重大升級——支援 **儲存工作流程並重播**：

```mermaid
graph TB
    subgraph "Templates 工作流程"
        Create["建立模板<br/>手動定義或從 Session 儲存"]
        Save["儲存模板<br/>含步驟、設定、技能"]
        Rerun["重播模板<br/>一鍵重新執行"]
        Share["分享模板<br/>團隊共享工作流程"]
    end
...
| 功能 | 說明 |
|------|------|
| Save from Session | 將當前 Session 工作流程直接儲存為模板 |
| Re-run Template | 一鍵在新專案中重新執行模板中的所有步驟 |
| 參數化模板 | 支援變數替換，適用不同專案 |
| 版本控制 | 模板支援版本管理 |
| 團隊共享 | 透過 OpenPackage 分享模板 |
...
### 11.14 Execution Plan Timeline（v0.11.180+ 新增）

OpenWork 新增了 **Execution Plan Timeline** 視覺化功能，將 OpenCode 的 Todo 任務以時間軸圖表呈現：

```mermaid
gantt
    title Execution Plan Timeline（範例）
    dateFormat HH:mm
    section Phase 1
    分析需求           :done, a1, 09:00, 5min
    設計架構           :done, a2, after a1, 10min
    section Phase 2
    實作 UserService   :active, b1, after a2, 15min
    實作 OrderService  :b2, after a2, 20min
    section Phase 3
    產生測試           :c1, after b1, 10min
    Code Review        :c2, after b2, 10min
    section Phase 4
    整合測試           :d1, after c2, 5min
```

| 功能 | 說明 |
|------|------|
| 即時更新 | 代理執行時，Timeline 即時反映進度 |
| 依賴視覺化 | 顯示任務間的依賴關係 |
| 預估時間 | 根據任務複雜度估算完成時間 |
| 互動操作 | 點擊任務可查看詳細日誌 |
| 匯出報告 | 將 Timeline 匯出為 PNG/PDF |

---

### 11.15 Cloud Worker 架構（v0.11.185+ 新增）

OpenWork 新增了 **Hosted Cloud Worker** 架構，允許將計算任務委託給雲端：
...
graph TB
    ...
    subgraph "Cloud Worker"
        Worker["Cloud Worker<br/>（託管 OpenCode 實例）"]
        Sandbox["安全沙箱<br/>（Docker/Firecracker）"]
    end

    subgraph "資源"
        GPU["GPU 加速<br/>（本地模型推理）"]
        Storage["雲端儲存"]
        LLM["AI 模型 API"]
    end
...
| 特點 | 說明 |
|------|------|
| 免本地資源 | 不佔用本機 CPU/Memory |
| 安全隔離 | 雲端沙箱環境，與本機隔離 |
| 並行能力 | 多個 Worker 並行執行 |
| 自動擴縮 | 根據任務量自動調整 Worker 數量 |
| localhost 安全 | 本地 Worker 預設綁定 localhost |

---

### 11.16 Workspace Switch 與 Starter Sessions（v0.11.190+ 新增）

**Workspace Switch Overlay：**

快速在不同工作空間之間切換，不需要關閉再重開：
...
|--------------|------|
| Blank | 空白工作空間 |
| React App | React + TypeScript 快速啟動 |
| API Server | Node.js / Python API 伺服器 |
| Full Stack | 前端 + 後端 + 資料庫 |
| Custom | 自訂 Starter（從模板建立） |

**Den——Daytona 支援的 Docker 開發流程：**

OpenWork 整合 Daytona，提供 **Den**（Development Environment）：
...
|------|------|
| 一鍵環境 | 自動建立完整開發環境 |
| 環境一致 | 團隊成員使用相同的 Docker 環境 |
| 快速銷毀 | 用完即棄，不汙染本機 |
| Daytona 支援 | 整合 Daytona 雲端開發平台 |

---

### 11.17 OpenCode Plugins 管理（Skills Tab）

OpenWork 的 Skills Tab 現在支援直接管理 OpenCode 外掛，透過讀寫 `opencode.json` 進行設定：

| 功能 | 說明 |
|------|------|
| 瀏覽外掛 | 瀏覽可用的 OpenCode 外掛（含 OmO） |
| 一鍵安裝 | 在 GUI 中直接安裝外掛 |
| 設定管理 | 視覺化設定外掛參數 |
| 版本管理 | 自動檢查更新、一鍵升級 |
| 範圍控制 | 專案層級（`<workspace>/opencode.json`）或全域層級（`~/.config/opencode/opencode.json`） |

---

### 11.18 OpenWork v0.11.192-v0.14.0 更新摘要

| 版本 | 重點更新 |
|------|----------|
| v0.11.192–v0.11.195 | React Session Composer（Lexical 編輯器）、增量式 React session path |
| v0.11.196–v0.11.200 | Ollama 本地模型支援、Provider Library 管理（組織管理 LLM 供應商） |
| v0.11.201–v0.11.203 | 國際化五語系（en/ja/zh/vi/pt-BR）自動偵測、共享 seeded paper gradients UI |
| v0.11.204 | 授權變更為 FSL-1.1-MIT（Functional Source License → 兩年後自動轉 MIT） |
| v0.11.205–v0.11.206 | Cloud Skills 管理、Provider 體驗優化、Anthropic browser auth 修正 |
| v0.11.207 | Composer 精練、Landing 頁面刷新、Catalan 語系新增（i18n 擴展至 6 語系）、microsandbox 沙箱流程、Roadmap 分頁、Node 24 CI 準備、Windows 免費下載恢復 |
| v0.12.x | pnpm workspace 重構（取代 npm）、OpenCode CLI+SDK 釘選至 v1.4.9、Electron 遷移準備、Infisical 專案配置 |
| v0.13.0 | **重大更新**：Tauri→Electron 完整遷移、Cloud MCP OAuth Server（`ee/` 目錄）、Welcome/Onboarding 畫面、Lexical SyncPlugin crash fix、command invocation timeout 修正、Electron artifact OS/arch 自動選擇、self-host guide 簡化、AUR PKGBUILD 更新至 0.13.0 |
| v0.13.1–v0.13.5 | pnpm workspace 深化重構、Electron browser automation（CDP）初始整合、AI Providers 頁面重新命名與 Preferences tab 新增、icon dedup、marketplace 整合、skill hubs 與 shared workspaces（soft-disabled） |
| v0.13.6–v0.13.7 | shadcn/ui skills 新增、Daytona/devcontainer 全端測試支援、native main menu 實作、pnpm minimum release age CI 強制、server-v2 與 openwork-server-sdk 清理 |
| v0.13.8 | 1,202 releases、15.2k ⭐、61 貢獻者；Electron browser automation in dev 完整啟用、CDP browser tools（直接 OpenCode 工具，無需 MCP，多目標）、AGENTS.md 更新、安全性改進 |
| v0.14.0 | 1,346 releases、15.7k ⭐、62 貢獻者；定位轉型為「open source alternative to Claude Cowork/Codex」、**Google Workspace OAuth** 身份驗證、**Voice mode CDP** 音訊檢查功能、**pnpm v11** 遷移、內建擴充市集（built-in extensions marketplace）、**SCIM/SSO** 企業管理流程、新版訊息列表 UI、embedded OpenCode 升級至 v1.15.12、Windows 透過付費支援計畫提供 |
...
| 時間 | 授權 | 說明 |
|------|------|------|
| v0.11.203 以前 | MIT | 完全開放原始碼 |
| v0.11.204 | FSL-1.1-MIT | Functional Source License，兩年後自動轉 MIT |
| v0.13.0+（現況） | MIT | 已恢復為 MIT 授權；`ee/` 目錄企業功能採 FSL-1.1-MIT |

| 項目 | 說明 |
|------|------|
| 現行授權 | **MIT**——完全開放原始碼 |
| EE 目錄 | `ee/` 目錄為企業版功能，採用 FSL-1.1-MIT |
| 企業影響 | 核心專案完全自由使用，僅 `ee/` 企業功能有限制 |

**Ollama 本地模型支援（v0.11.200+）：**

OpenWork 現在可直接使用 Ollama 本地模型，無需雲端 API：
...
在 Settings → Debug 中可匯出：
- **Runtime Debug Report**：執行時診斷報告
- **Developer Log Stream**：開發者日誌串流

這些資訊在提交 Bug Report 時非常有用。

**Windows 支援：**

OpenWork 的 Windows 版本目前透過付費支援方案提供：
- 下載頁面：[openworklabs.com/pricing#windows-support](https://openworklabs.com/pricing#windows-support)
- macOS 與 Linux 可直接免費下載

---

### 11.19 OpenWork v0.14.1-v0.17.4 更新摘要

OpenWork 在 v0.14.0 之後繼續快速迭代，至 **v0.17.4**（2026 年 6 月）已累計 **1,610 releases**、**16.5k Stars**、**65 貢獻者**。
...
這意味著 OpenWork 現在直接對標 Anthropic 的 Claude Cowork 產品，提供完全開源的替代方案。

#### 架構確認：仍使用 Tauri

**重要修正**：儘管先前版本紀錄提到「Tauri → Electron 遷移」，根據最新原始碼確認，OpenWork Desktop 仍然使用 **Tauri** 框架（需要 Rust toolchain 與 WebKitGTK）。OpenCode Desktop（獨立產品）才是使用 Electron。兩者區別如下：

| 產品 | 框架 | 說明 |
|------|------|------|
| **OpenWork Desktop** | Tauri | 使用 Rust + WebKitGTK，體積小、效能高 |
| **OpenCode Desktop** | Electron | OpenCode 自己的桌面應用（BETA） |

#### SignPath.io 程式碼簽署

OpenWork 現在由 [SignPath.io](https://about.signpath.io/) 提供免費程式碼簽署：

| 項目 | 說明 |
|------|------|
| 簽署提供者 | SignPath.io（免費） |
| 憑證機構 | SignPath Foundation |
| 簽署者 | OpenWork 倉庫協作者 + Different AI 組織核心成員 |
| 核准者 | Different AI 組織擁有者 |

#### OpenWork Orchestrator CLI

新增獨立的 CLI 主機模式，無需桌面 UI 即可運行：
...
這對於 CI/CD 環境或無頭伺服器（headless server）場景非常實用。

#### Docker Images 發佈

OpenWork 現已發佈多個 Docker 映像：

| 映像 | 用途 |
|------|------|
| `ghcr.io/different-ai/openwork-eval-vnc` | 評估環境（含 VNC） |
| `ghcr.io/different-ai/openwork-den-api` | Den API 伺服器 |
| `ghcr.io/different-ai/charts/openwork-ee` | Enterprise Helm Chart |

#### 開發環境更新

| 項目 | 需求 |
|------|------|
| Node.js | 依 `.nvmrc` 指定版本 |
| pnpm | **v10.27.0**（workspace 管理） |
| Bun | **1.3.9+**（建置需要） |
| Rust | stable（Tauri 建置） |
| WebKitGTK | 4.1+（Linux） |
| OpenCode CLI | 已安裝且在 PATH 中 |

**Dev Mode 隔離改善：**

```bash
# pnpm dev 現在自動啟用隔離模式
# 使用獨立的 OpenCode state，不影響個人全域設定
OPENWORK_DEV_MODE=1  # 自動設定
```

#### v0.14.x–v0.17.x 版本亮點

| 版本範圍 | 重點更新 |
|----------|----------|
| v0.14.x | Google Workspace OAuth、SCIM/SSO、pnpm v11 遷移 |
| v0.15.x | 內建擴充市集穩定化、embedded OpenCode 版本同步升級 |
| v0.16.x | Tauri dialog 能力改善、Dev Mode 自動隔離、WebKitGTK 相容修正 |
| v0.17.x | **最新**（v0.17.4）：session title hover、skill-lock.json 穩定、turbo.json 建置最佳化、e2e 測試完善 |

#### Wayland/Hyprland 疑難排解

Linux Wayland 環境（如 Hyprland）可能遇到 WebKitGTK 錯誤：
...
### 11.20 企業導入 OpenWork 建議

**Enterprise Plan（企業方案）：**

OpenWork 提供 [Enterprise Plan](https://openworklabs.com/enterprise)，包含以下增值服務：

| 功能 | 說明 |
|------|------|
| 功能優先開發 | 企業需求優先進入開發排程 |
| SSO 單一登入 | 整合企業身分認證系統 |
| SLA 服務等級協定 | 保證回應時間與可用性 |
| LTS 長期支援版本 | 穩定版本長期維護 |
| 專屬支援 | 直接聯繫 OpenWork 團隊 |

> 企業洽詢：[ben@openworklabs.com](mailto:ben@openworklabs.com) 或 [預約會議](https://cal.com/team/openwork/enterprise)

**Windows 下載注意事項：**

- macOS 與 Linux 下載免費提供
- Windows 下載目前透過付費支援方案取得：[openworklabs.com/pricing#windows-support](https://openworklabs.com/pricing#windows-support)
- 雲端 OpenWork Cloud workers 可從 web app 購買後啟動，再透過桌面應用 `Add a worker` → `Connect remote` 連線
...
- [ ] 安裝 OmO（`bun i -g oh-my-openagent`）
- [ ] 使用 ultrawork 啟動
- [ ] 嘗試 /init-deep
- [ ] 安裝 OpenWork Desktop
- [ ] 設定 OpenPackage
...
| 快速鍵 | 功能 | 說明 |
|--------|------|------|
| `Tab` | 切換代理 | Plan ↔ Build 循環 |
| `Ctrl+C` | 中斷 | 中斷當前操作 |
| `@` | 檔案搜尋 | 模糊搜尋專案檔案 |
| `@general` | 呼叫子代理 | 呼叫 General SubAgent |
| `@explore` | 探索代理 | 快速唯讀程式碼探索 |
| `@scout` | 偵察代理 | 外部文件與依賴研究 |
| `Leader+Right` | 切換子工作階段 | 向前循環父/子工作階段 |
| `Leader+Left` | 反向切換 | 向後循環父/子工作階段 |

**CLI 指令：**

| 指令 | 功能 | 說明 |
|------|------|------|
| `opencode` | 啟動 TUI | 在當前目錄啟動 |
| `opencode agent create` | 建立代理 | 互動式建立自訂代理 |
| `opencode models` | 列出模型 | 顯示可用模型清單 |
| `opencode serve` | 啟動伺服器 | 啟動 OpenCode Server |
| `opencode --version` | 版本資訊 | 顯示當前版本 |

---

## 附錄 C：OmO 指令速查表

**Ultimate Edition（OpenCode）指令：**

| 指令 | 功能 | 說明 |
|------|------|------|
| `ultrawork` / `ulw` | 啟動 OmO | 一鍵啟動完整環境 |
| `/init-deep` | 深度初始化 | 產生階層式 AGENTS.md |
| `/start-work` | 啟動 Prometheus | 面試模式策略規劃 |
| `/ulw-loop` | 持久迴圈 | 多目標編排與證據審計 |
| `@general` | 呼叫子代理 | 複雜搜尋或多步驟任務 |
| 背景代理 | 自動管理 | 由 Sisyphus 自動調度（5+ 並行） |
| Hash-Anchored Edit | 自動啟用 | LINE#ID 內容雜湊驗證編輯 |
| Ralph Loop | 自動驗證 | 每次編輯後自動檢查 |
| Todo Enforcer | 自動追蹤 | 追蹤 TODO 完成狀態 |
| Comment Checker | 自動檢查 | 偵測 AI 臨時註解（兩版本均可用） |
| Team Mode tools | `team_create` 等 | 啟用 Team Mode 後解鎖 |

**Light Edition（Codex CLI）指令：**

| 指令 | 功能 | 說明 |
|------|------|------|
| `npx lazycodex-ai install` | 安裝 Light | 一鍵安裝 Codex CLI 版 |
| `npx lazycodex-ai uninstall` | 卸載 Light | 清除所有 Codex 插件狀態 |
| `ultrawork` / `ulw` | 啟動（Light） | Light 版中的一鍵啟動 |

**管理指令：**

| 指令 | 功能 | 說明 |
|------|------|------|
| `bunx oh-my-openagent install` | 安裝 Ultimate | TUI 引導安裝流程 |
| `bunx oh-my-openagent install --platform=both` | 雙版本安裝 | 同時安裝 Ultimate + Light |
| `bunx oh-my-opencode doctor` | 診斷檢查 | 驗證設定、模型、環境 |
| `omo uninstall --platform=codex` | 卸載 Codex | 清除 Codex 平台組件 |
...
> **文件結束**  
> 本文件涵蓋 OpenCode v1.17.11、Oh My OpenAgent v4.14.1、OpenWork v0.17.4 的完整生態系教學。  
