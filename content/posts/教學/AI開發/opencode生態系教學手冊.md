...
> **版本**：基於 OpenCode v1.3.2（2026 年 3 月）  
...
- [第十一章：OpenWork 桌面應用與協作平台](#第十一章openwork-桌面應用與協作平台)
  ...
  - [11.18 企業導入 OpenWork 建議](#1118-企業導入-openwork-建議)
...
graph TB
    subgraph "OpenCode 生態系"
        subgraph "核心層"
            OC["OpenCode Core<br/>v1.3.2<br/>130k ⭐ | MIT"]
        end

        subgraph "增強層"
            OmO["Oh My OpenAgent (OmO)<br/>v3.13.1<br/>43.3k ⭐ | SUL"]
            OW["OpenWork<br/>v0.11.191<br/>12.4k ⭐ | MIT"]
        end

        subgraph "整合層"
            SDK["OpenCode SDK<br/>v1.3.x"]
...
|------|------|--------|------|-------|------|
| **OpenCode** | AI 編碼代理核心 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | v1.3.2 | 130k | MIT |
| **Oh My OpenAgent** | 進階外掛（多代理協作） | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | v3.13.1 | 43.3k | SUL |
| **OpenWork** | 桌面 GUI 協作平台 | [different-ai/openwork](https://github.com/different-ai/openwork) | v0.11.191 | 12.4k | MIT |
...
| v1.3.2 | 2026-03-25 | 最新穩定版，Electron Desktop App 改進、MCP OAuth 增強 |
...
| v3.13.1 | 最新版，156 releases；Metis（Plan Consultant）、Agent Orchestration、Session Tools、Think Mode |
...
| v0.11.191 | 最新版，1,027 releases；Dev Mode 隔離、Cloud Worker、Workspace Switch、Starter Sessions |
...
graph TB
    subgraph "介面層（Clients）"
        TUI["TUI（終端機介面）"]
        Desktop["Desktop App"]
        IDE["IDE Extension<br/>（VS Code SDK v1.3.2）"]
        Web["Web 介面"]
        Mobile["遠端操控<br/>（行動裝置）"]
...
OpenCode 提供 **VS Code 擴充（SDK v1.3.2）**：
...
graph TB
    subgraph "Agent Orchestration 四大類別"
        ...
        Deep["🔨 deep<br/>Hephaestus<br/>gpt-5.3-codex"]
...
**oh-my-opencode.jsonc 設定檔支援：**

除了 YAML 設定外，v3.13 新增 JSONC 格式設定檔支援：
...
| 版本發佈 | **1,027+** |
| 授權 | **MIT** |
| 技術堆疊 | TypeScript 78.3% / JavaScript 9.9% / Rust 6.7% / CSS 3.8%（Tauri） |
| OpenCode 版本 PIN | **1.3.x**（CI 固定） |
...
OpenWork 的 Skills Tab 現在支援直接管理 OpenCode 外掛：
...
> **文件結束**  
> 本文件涵蓋 OpenCode v1.3.2、Oh My OpenAgent v3.13.1、OpenWork v0.11.191 的完整生態系教學。  
