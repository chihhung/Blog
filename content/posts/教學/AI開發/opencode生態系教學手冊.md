...
> **版本**：基於 OpenCode v1.14.30（2026 年 4 月）  
...
OpenCode 是一個 **100% 開源** 的 AI 編碼代理（AI Coding Agent），由 Anomaly 團隊開發維護。截至 2026 年 4 月，OpenCode 已達到以下里程碑：
...
| 語言/技術 | 佔比 | 用途 |
|-----------|------|------|
| TypeScript | 59.4% | 核心引擎、工具系統 |
| MDX | 37.0% | 文件系統 |
| CSS | 2.8% | TUI 樣式 |
| Rust | 0.4% | 效能關鍵路徑、Desktop App |
| Astro | 0.2% | 文件網站 |
...
graph TB
    subgraph "OpenCode 生態系"
        subgraph "核心層"
            OC["OpenCode Core<br/>v1.14.30<br/>152k ⭐ | MIT"]
        end

        subgraph "增強層"
            OmO["Oh My OpenAgent (OmO)<br/>v3.17.10<br/>55.1k ⭐ | SUL"]
            OW["OpenWork<br/>v0.13.0<br/>14.5k ⭐ | MIT"]
        end
...
|------|------|--------|------|-------|------|
| **OpenCode** | AI 編碼代理核心 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | v1.14.30 | 152k | MIT |
| **Oh My OpenAgent** | 進階外掛（多代理協作） | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | v3.17.10 | 55.1k | SUL |
| **OpenWork** | 桌面 GUI 協作平台 | [different-ai/openwork](https://github.com/different-ai/openwork) | v0.13.0 | 14.5k | MIT |
...
| v1.14.30 | 2026-04-30 | 最新穩定版；152k Stars、875 貢獻者、781 releases；question 工具、agent create CLI 互動式建立代理、Desktop App BETA 正式化、VS Code SDK v1.14.30、server status indicator 修正、sourcemaps for beta releases、HttpApi instance context middleware、type-aware no-floating-promises 規則 |
...
| v3.17.3 | 164 releases；replace_plan 支援、CLA 貢獱者授權協議、PostHog 匿名 Telemetry、Sisyphus Labs 產品化等待名單 |
| v3.17.10 | **最新版**，168 releases、55.1k ⭐、199 貢獱者；GPT-5.5 native prompt drafts、npm OIDC CI、auto-update-checker 修正、maxDescendants 移除 |
...
| v0.13.0 | **最新版**，1,087 releases、14.5k ⭐、57 貢獻者；Tauri→Electron 完整遷移、Cloud MCP OAuth Server、Welcome/Onboarding 畫面、AUR PKGBUILD 更新 |
...
graph TB
    subgraph "介面層（Clients）"
        TUI["TUI（終端機介面）"]
        Desktop["Desktop App"]
        IDE["IDE Extension<br/>（VS Code SDK v1.14.30）"]
        Web["Web 介面"]
        Mobile["遠端操控<br/>（行動裝置）"]
...
OpenCode 提供 **VS Code 擴充（SDK v1.14.30）**：
...
| 版本發佈 | **1,087+** |
| 授權 | **MIT** |
| 技術堆疊 | TypeScript 83.9% / JavaScript 8.3% / Rust 3.6% / CSS 2.5% / Shell 1.0% / MDX 0.7% |
| OpenCode 版本 PIN | **1.4.9**（CI 固定，透過 `constants.json`） |
| 官方網站 | [openworklabs.com](https://openworklabs.com) |
| Desktop Framework | **Electron**（從 Tauri 遷移至 Electron，v0.13.0） |
| 應用程式語言 | 英文、日文、簡體中文、越南文、巴西葡萄牙文 |
...
> **文件結束**  
> 本文件涵蓋 OpenCode v1.14.30、Oh My OpenAgent v3.17.10、OpenWork v0.13.0 的完整生態系教學。  
