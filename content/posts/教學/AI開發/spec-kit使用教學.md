...
> **版本**: 11.0  
> **最後更新**: 2026年5月29日  
> **適用於**: Spec-Kit v0.8.17+ / Spec Kit Templates - 0.8.17  
...
Spec-Kit 支援多種主流 AI 編碼助手（截至 v0.8.17，30+ 個代理）：
...
截至 v0.8.17，社群目錄中已有豐富的擴充可供使用（約 105+ 個）：
...
v0.8.17（2026-05-28）為截至本文撰寫時的**最新穩定版本**，重點包含新代理整合、社群文件整合，以及多項擴充更新。
...
> **升級提示**：從任何版本升級至 v0.8.17，請使用以下指令。詳見 [升級指南](https://github.com/github/spec-kit/blob/main/docs/upgrade.md)：
>
> ```bash
> # 檢查是否有新版本
> specify self check
>
> # 升級 CLI（uv）
> uv tool install specify-cli --force --from git+https://github.com/github/spec-kit.git@v0.8.17
>
> # 或使用 pipx
> pipx install --force git+https://github.com/github/spec-kit.git@v0.8.17
>
